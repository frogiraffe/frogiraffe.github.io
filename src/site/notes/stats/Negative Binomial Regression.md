---
{"dg-publish":true,"permalink":"/stats/negative-binomial-regression/","tags":["Statistics","Regression","GLM","Count-Data","Overdispersion"]}
---
...
> **Negative Binomial Regression** is an extension of [[stats/Poisson Regression\|Poisson Regression]] used when count data exhibits ==overdispersion== (Variance > Mean). It introduces an extra parameter to model the heterogeneity in event rates across observations.
...
> - Outcome is a **count**.
> - The [[stats/Poisson Regression\|Poisson Regression]] model shows **overdispersion** (Dispersion statistic > 1.5).
...
> - Excess zeros are the main problem (use [[stats/Zero-Inflated Models\|Zero-Inflated Models]]).
...
> [!warning] Pitfalls
> 1.  **Still sensitive to excess zeros.** If you have structural zeros (e.g., people who will *never* use a product), consider [[stats/Zero-Inflated Models\|Zero-Inflated Models]].
...
- [[stats/Poisson Regression\|Poisson Regression]] - The baseline count model.
- [[stats/Zero-Inflated Models\|Zero-Inflated Models]] - For excess zeros.
