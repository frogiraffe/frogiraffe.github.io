---
{"dg-publish":true,"permalink":"/stats/one-sample-t-test/","tags":["Statistics","Hypothesis-Testing","Parametric-Tests","T-Test"]}
---
...
- [ ] **Normality:** Sample data should be approximately normally distributed (or $n$ large enough for [[stats/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]]).
...
- [[stats/Student's T-Test\|Student's T-Test]] - The two-sample version.
- [[stats/Z-Test\|Z-Test]] - Used if $\sigma$ is known.
- [[stats/Confidence Intervals\|Confidence Intervals]] - The interval version of this test.
