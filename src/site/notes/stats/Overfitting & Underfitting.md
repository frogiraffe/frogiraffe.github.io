---
{"dg-publish":true,"permalink":"/stats/overfitting-and-underfitting/","tags":["Statistics","Machine-Learning","Model-Validation","Diagnostics"]}
---
...
> - **High variance** in [[stats/Cross-Validation\|Cross-Validation]] folds.
...
| Method | Mechanism |
|--------|-----------|
| **[[stats/Cross-Validation\|Cross-Validation]]** | Evaluate on multiple test folds; detects overfitting. |
| **Regularization** ([[stats/Ridge Regression\|Ridge Regression]], [[stats/Lasso Regression\|Lasso Regression]]) | Penalize large coefficients; reduce model complexity. |
...
> [!warning] Pitfalls
> 1. **Cannot truly eliminate both.** [[stats/Bias-Variance Trade-off\|Bias-Variance Trade-off]] is fundamental.
...
- [[stats/Bias-Variance Trade-off\|Bias-Variance Trade-off]] - Theoretical foundation.
- [[stats/Cross-Validation\|Cross-Validation]] - Detection method.
- [[stats/Ridge Regression\|Ridge Regression]] / [[stats/Lasso Regression\|Lasso Regression]] - Prevention via regularization.
