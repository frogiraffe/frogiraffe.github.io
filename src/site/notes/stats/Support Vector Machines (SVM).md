---
{"dg-publish":true,"permalink":"/stats/support-vector-machines-svm/","tags":["Statistics","Machine-Learning","Supervised-Learning","Classification","Regression"]}
---
...
- [[stats/Logistic Regression\|Logistic Regression]] - Alternative linear classifier (Probs).
- [[Kernel Density Estimation\|Kernel Density Estimation]] - Related to RBF.
- [[stats/Overfitting & Underfitting\|Overfitting & Underfitting]] - Controlled by C and Gamma.
