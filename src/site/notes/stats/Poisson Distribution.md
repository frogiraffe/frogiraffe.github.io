---
{"dg-publish":true,"permalink":"/stats/poisson-distribution/","tags":["Statistics","Probability-Theory","Distributions","Discrete"]}
---
...
2.  Baseline model for **Count Regression** ([[stats/Poisson Regression\|Poisson Regression]]).
...
- [[stats/Poisson Regression\|Poisson Regression]] - Predicting counts with covariates.
- [[stats/Exponential Distribution\|Exponential Distribution]] - Time *between* Poisson events.
- [[stats/Negative Binomial Regression\|Negative Binomial Regression]] - For overdispersed counts.
- [[stats/Binomial Distribution\|Binomial Distribution]] - Poisson is limit as $n \to \infty, p \to 0$.
