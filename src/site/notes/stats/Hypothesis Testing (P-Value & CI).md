---
{"dg-publish":true,"permalink":"/stats/hypothesis-testing-p-value-and-ci/","tags":["Statistics","Foundations","Hypothesis-Testing","Inference"]}
---
...
> 2.  **Statistical Significance $\neq$ Practical Significance.** A p-value of 0.001 for a tiny effect (e.g., 0.001 kg weight loss) is meaningless. Always report [[stats/Effect Size Measures\|Effect Size Measures]].
> 3.  **Multiple Comparisons Problem:** Running 20 tests at $\alpha = 0.05$ guarantees roughly 1 false positive by chance. Use [[stats/Bonferroni Correction\|Bonferroni Correction]] or FDR.
...
- [[stats/Power Analysis\|Power Analysis]]
...
- [[stats/Bayesian Statistics\|Bayesian Statistics]] - An alternative framework.
