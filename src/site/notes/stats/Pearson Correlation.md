---
{"dg-publish":true,"permalink":"/stats/pearson-correlation/","tags":["Statistics","Correlation","Parametric-Tests","Association"]}
---
...
2.  Serve as a preliminary step before [[stats/Simple Linear Regression\|Simple Linear Regression]].
3.  Identify potential multicollinearity issues in [[stats/Multiple Linear Regression\|Multiple Linear Regression]].
...
> - **Non-linear relationship:** Consider [[stats/Spearman's Rank Correlation\|Spearman's Rank Correlation]].
> - **Ordinal data:** Use Spearman or [[stats/Kendall's Tau\|Kendall's Tau]].
...
- [[stats/Spearman's Rank Correlation\|Spearman's Rank Correlation]] - Non-parametric alternative.
- [[stats/Kendall's Tau\|Kendall's Tau]] - For small samples, ordinal data.
- [[stats/Simple Linear Regression\|Simple Linear Regression]] - Models the relationship.
- [[stats/Correlation vs Causation\|Correlation vs Causation]]