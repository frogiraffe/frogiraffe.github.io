---
{"dg-publish":true,"permalink":"/stats/q-q-plot/","tags":["Statistics","Diagnostics","Normality","Visualization"]}
---
...
> A **Q-Q Plot (Quantile-Quantile Plot)** is a graphical tool to compare the distribution of a sample against a theoretical distribution (usually the [[stats/Normal Distribution\|Normal Distribution]]). It plots ==sample quantiles against theoretical quantiles==. If the data follows the theoretical distribution, points will fall on a straight diagonal line.
...
3.  Complement statistical tests (e.g., [[stats/Shapiro-Wilk Test\|Shapiro-Wilk Test]]) with visual evidence.
...
| **Curve (Concave)** | Right Skew. | Income data. Use [[stats/Log Transformations\|Log Transformations]]. |
...
> 3.  **Not a formal test:** Use [[stats/Shapiro-Wilk Test\|Shapiro-Wilk Test]] for statistical confirmation.
...
- [[stats/Shapiro-Wilk Test\|Shapiro-Wilk Test]] - Statistical test for normality.
- [[stats/Normal Distribution\|Normal Distribution]] - The reference distribution.
- [[stats/Log Transformations\|Log Transformations]] - Fix for skewness.