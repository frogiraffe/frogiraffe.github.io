...
> - Series has **complex autocorrelation** structure (use [[stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]]).
...
**Time Series Methods:**
- [[stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]] - Box-Jenkins approach
- [[stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Prerequisite for some methods
