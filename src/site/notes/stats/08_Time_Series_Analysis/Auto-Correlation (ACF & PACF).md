...
These are the primary tools for identifying the order (p, q) of [[stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]].
...
- [[stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]] - The model built using these tools.
- [[stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Prerequisite.
- [[stats/02_Statistical_Inference/Ljung-Box Test\|Ljung-Box Test]] - Statistical test for "White Noise" (checking group of lags).
