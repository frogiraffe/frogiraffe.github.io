...
> A time series is **Stationary** if its statistical properties (mean, variance, autocorrelation) ==do not change over time==. Stationarity is a **prerequisite** for many time series models like [[stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]].
...
- [[stats/08_Time_Series_Analysis/GARCH Models\|GARCH Models]] - For non-constant variance.
