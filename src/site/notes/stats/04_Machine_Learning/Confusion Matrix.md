...
> 2.  **Threshold Dependent:** Metrics change with the classification threshold. Use [[stats/04_Machine_Learning/ROC & AUC\|ROC & AUC]] for threshold-independent evaluation.
