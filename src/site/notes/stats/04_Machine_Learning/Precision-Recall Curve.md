---
{"dg-publish":true,"permalink":"/stats/04-machine-learning/precision-recall-curve/","tags":["Machine-Learning","Evaluation","Classification","Imbalanced-Data"]}
---
...
> - Comparing models where [[stats/04_Machine_Learning/ROC & AUC\|ROC & AUC]] gives **misleadingly optimistic** results.
...
**Prerequisites:**
- [[stats/04_Machine_Learning/Confusion Matrix\|Confusion Matrix]] — TP, FP, FN definitions
- [[stats/03_Regression_Analysis/Binary Logistic Regression\|Binary Logistic Regression]] — Common classifier to evaluate

**Companions:**
- [[stats/04_Machine_Learning/ROC & AUC\|ROC & AUC]] — Alternative for balanced data
