...
> 3.  **High Dimensions:** In very high dimensions, Euclidean distance loses meaning (Curse of Dimensionality). Use [[stats/04_Machine_Learning/Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]] first.
