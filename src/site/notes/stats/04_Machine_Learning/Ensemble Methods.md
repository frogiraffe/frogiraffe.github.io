---
{"dg-publish":true,"permalink":"/stats/04-machine-learning/ensemble-methods/","tags":["Machine-Learning","Algorithms","Model-Combination","Variance-Reduction"]}
---
...
|----------|------|----------|-------------|---------------|
| **Bagging** | Reduce Variance | Parallel (independent) | Voting / Averaging | [[stats/04_Machine_Learning/Random Forest\|Random Forest]] |
| **Boosting** | Reduce Bias | Sequential (dependent) | Weighted sum | [[stats/04_Machine_Learning/Gradient Boosting (XGBoost)\|Gradient Boosting (XGBoost)]] |
...
**Core Algorithms:**
- [[stats/04_Machine_Learning/Random Forest\|Random Forest]] — Bagging with Decision Trees
- [[stats/04_Machine_Learning/Gradient Boosting (XGBoost)\|Gradient Boosting (XGBoost)]] — Sequential boosting
- [[AdaBoost\|AdaBoost]] — Original boosting algorithm

**Prerequisites:**
- [[stats/04_Machine_Learning/Decision Tree\|Decision Tree]] — Base learner for most ensembles
- [[stats/01_Foundations/Bias-Variance Trade-off\|Bias-Variance Trade-off]] — Theoretical foundation
- [[stats/04_Machine_Learning/Cross-Validation\|Cross-Validation]] — For stacking and model selection
