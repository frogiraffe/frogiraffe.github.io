---
{"dg-publish":true,"permalink":"/stats/01-foundations/multivariate-normal-distribution/","tags":["probability","distributions","continuous","multivariate"]}
---
...
- $\boldsymbol{\Sigma}$ = covariance matrix ($k \times k$, symmetric, [[stats/01_Foundations/Positive Definite Matrices\|positive definite]])
...
The exponent in the PDF is the squared [[Mahalanobis Distance\|Mahalanobis Distance]]:
...
| Application | Use |
|-------------|-----|
| **[[Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]]** | Data → principal components (MVN eigenvectors) |
| **Gaussian Processes** | Prior/posterior are MVN |
| **[[Linear Discriminant Analysis (LDA)\|Linear Discriminant Analysis (LDA)]]** | Class-conditional densities |
| **[[stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]]** | Error term $\boldsymbol{\varepsilon} \sim \mathcal{N}(\mathbf{0}, \sigma^2\mathbf{I})$ |
...
- [[stats/01_Foundations/Covariance Matrix\|Covariance Matrix]] - Second parameter
- [[Mahalanobis Distance\|Mahalanobis Distance]] - Distance metric for MVN

### Hypothesis Testing
- [[stats/02_Statistical_Inference/Hotelling's T-Squared\|Hotelling's T-Squared]] - Multivariate t-test
