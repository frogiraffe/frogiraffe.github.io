---
{"dg-publish":true,"permalink":"/stats/01-foundations/covariance/","tags":["probability","descriptive-statistics","association","foundations"]}
---
...
2. Build [[stats/01_Foundations/Covariance Matrix\|covariance matrices]] for multivariate analysis
3. Calculate [[stats/01_Foundations/Correlation Analysis\|correlation]] (covariance standardized by SDs)
4. Understanding [[stats/01_Foundations/Multivariate Normal Distribution\|MVN]] and [[Principal Component Analysis (PCA)\|PCA]]
...
- [[stats/01_Foundations/Variance\|Variance]] - Covariance with itself
- [[stats/01_Foundations/Covariance Matrix\|Covariance Matrix]] - Multiple variables

### Applications
- [[stats/01_Foundations/Multivariate Normal Distribution\|Multivariate Normal Distribution]] - Uses covariance matrix
- [[Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]] - Eigendecomposition of covariance
- [[Portfolio Theory\|Portfolio Theory]] - Covariance between asset returns
