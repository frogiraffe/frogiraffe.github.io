---
{"dg-publish":true,"permalink":"/stats/01-foundations/chi-square-distribution/","tags":["probability","distributions","continuous","hypothesis-testing"]}
---
...
3. Form the basis of the [[stats/02_Statistical_Inference/Chi-Square Test of Independence\|Chi-Square Test of Independence]] and [[stats/02_Statistical_Inference/Goodness-of-Fit Test\|Goodness-of-Fit Test]].
...
> - [[stats/02_Statistical_Inference/Goodness-of-Fit Test\|Goodness-of-Fit Test]] - Does data fit a theoretical distribution?
...
> - **Expected frequencies too low:** Rule of thumb: all expected counts should be ≥ 5. Use [[stats/02_Statistical_Inference/Fisher's Exact Test\|Fisher's Exact Test]] otherwise.
> - **Non-normal data for variance tests:** Chi-square variance test assumes normality.
> - **Paired/dependent data:** Use [[stats/02_Statistical_Inference/McNemar's Test\|McNemar's Test]] instead of chi-square independence test.
...
|--------------|--------------|
| [[stats/01_Foundations/Normal Distribution\|Normal Distribution]] | $\chi^2_1 = Z^2$ where $Z \sim N(0,1)$ |
| [[stats/01_Foundations/T-Distribution\|T-Distribution]] | $t = Z / \sqrt{\chi^2_k/k}$ |
| [[stats/01_Foundations/F-Distribution\|F-Distribution]] | $F = (\chi^2_1/df_1) / (\chi^2_2/df_2)$ |
| [[stats/01_Foundations/Gamma Distribution\|Gamma Distribution]] | $\chi^2_k = \text{Gamma}(k/2, 2)$ |
...
> [!warning] Pitfalls
> 1. **Small expected frequencies:** Chi-square test is unreliable when expected counts < 5. Use [[stats/02_Statistical_Inference/Fisher's Exact Test\|Fisher's Exact Test]].
...
### Directly Related
- [[stats/02_Statistical_Inference/Chi-Square Test of Independence\|Chi-Square Test of Independence]] - Testing association in contingency tables
- [[stats/02_Statistical_Inference/Goodness-of-Fit Test\|Goodness-of-Fit Test]] - Testing distributional fit
- [[stats/01_Foundations/F-Distribution\|F-Distribution]] - Ratio of two chi-squares
- [[stats/01_Foundations/T-Distribution\|T-Distribution]] - Uses chi-square in its definition

### Applications
- [[stats/03_Regression_Analysis/Breusch-Pagan Test\|Breusch-Pagan Test]] - Heteroscedasticity testing
- [[stats/03_Regression_Analysis/White Test\|White Test]] - Heteroscedasticity testing
