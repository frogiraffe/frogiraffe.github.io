...
> **Bayes' Theorem** is a fundamental result in probability theory that describes how to ==update beliefs== in light of new evidence. It provides the mathematical foundation for [[stats/01_Foundations/Bayesian Statistics\|Bayesian Statistics]] and probabilistic reasoning.
