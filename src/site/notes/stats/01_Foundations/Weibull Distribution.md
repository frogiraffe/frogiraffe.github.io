---
{"dg-publish":true,"permalink":"/stats/01-foundations/weibull-distribution/","tags":["probability","distributions","continuous","survival-analysis","reliability"]}
---

## Definition

> [!abstract] Core Statement
> The **Weibull Distribution** models ==time-to-event data== with flexible hazard functions. It generalizes the [[stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] by allowing the hazard rate to increase, decrease, or stay constant over time.
...
> - Need flexibility beyond [[stats/01_Foundations/Exponential Distribution\|Exponential Distribution]]
...
> - **Constant hazard:** Use [[stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] (simpler, Weibull with k=1)
> - **Multiple failure modes:** Consider mixture models
> - **Non-monotonic hazard:** Weibull only handles monotonic hazards
> - **Complex survival patterns:** Use [[stats/02_Statistical_Inference/Cox Proportional Hazards\|Cox Proportional Hazards]] for flexibility
...
| **k = 1** | **Constant** hazard | Reduces to [[stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] — no aging |
...
- [[stats/01_Foundations/Gamma Distribution\|Gamma Distribution]] - Alternative for sum of waiting times
- [[stats/07_Causal_Inference/Survival Analysis\|Survival Analysis]] - Primary application

### Applications
- [[stats/02_Statistical_Inference/Hazard Ratio\|Hazard Ratio]] - Hazard function comparisons
- [[stats/02_Statistical_Inference/Kaplan-Meier Curves\|Kaplan-Meier Curves]] - Non-parametric alternative
- [[stats/02_Statistical_Inference/Cox Proportional Hazards\|Cox Proportional Hazards]] - Semi-parametric alternative
