---
{"dg-publish":true,"permalink":"/stats/01-foundations/convergence/","tags":["probability","optimization","machine-learning","theory"]}
---
...
- [[stats/01_Foundations/Law of Large Numbers\|Law of Large Numbers]] - $\bar{X}_n \xrightarrow{p} \mu$
- [[stats/01_Foundations/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]] - $\sqrt{n}(\bar{X}_n - \mu) \xrightarrow{d} N(0,\sigma^2)$
- [[stats/01_Foundations/Chebyshev's Inequality\|Chebyshev's Inequality]] - Used in convergence proofs

### Optimization
- [[stats/04_Supervised_Learning/Gradient Descent\|Gradient Descent]] - Common algorithm needing convergence check
- [[stats/01_Foundations/Loss Function\|Loss Function]] - What optimization minimizes
