---
{"dg-publish":true,"permalink":"/stats/auto-correlation-acf-and-pacf/","tags":["Statistics","Time-Series","Diagnostics","Visualization"]}
---
...
These are the primary tools for identifying the order (p, q) of [[stats/ARIMA Models\|ARIMA Models]].
...
- [[stats/ARIMA Models\|ARIMA Models]] - The model built using these tools.
