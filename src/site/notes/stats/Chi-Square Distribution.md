---
{"dg-publish":true,"permalink":"/stats/chi-square-distribution/","tags":["Statistics","Probability-Theory","Distributions","Hypothesis-Testing"]}
---
...
3. Form the basis of the [[stats/Chi-Square Test of Independence\|Chi-Square Test of Independence]] and goodness-of-fit tests.
4. Related to the [[stats/F-Distribution\|F-Distribution]] in ANOVA.
...
> - [[stats/Chi-Square Test of Independence\|Chi-Square Test of Independence]] - Testing association between categorical variables.
...
> - **Heteroscedasticity Tests** ([[stats/Breusch-Pagan Test\|Breusch-Pagan Test]], [[stats/White Test\|White Test]]).
...
- **High df (e.g., 30+):** Approximately normal due to [[stats/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]].
...
- [[stats/Chi-Square Test of Independence\|Chi-Square Test of Independence]]
- [[stats/Normal Distribution\|Normal Distribution]] - $\chi^2$ is the sum of squared normals.
- [[stats/F-Distribution\|F-Distribution]] - Ratio of two chi-squares.
- [[stats/Degrees of Freedom\|Degrees of Freedom]]
