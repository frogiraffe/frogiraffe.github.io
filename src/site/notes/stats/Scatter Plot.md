---
{"dg-publish":true,"permalink":"/stats/scatter-plot/","tags":["Statistics","Visualization","EDA","Bivariate"]}
---
...
> 2.  **Correlation $\neq$ Causation:** A perfect line does not mean X causes Y. (See [[stats/Correlation vs Causation\|Correlation vs Causation]]).
...
- [[stats/Pearson Correlation\|Pearson Correlation]] - The number summarizing the plot.
- [[stats/Simple Linear Regression\|Simple Linear Regression]] - Fitting a line to the plot.
