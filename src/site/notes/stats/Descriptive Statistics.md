---
{"dg-publish":true,"permalink":"/stats/descriptive-statistics/","tags":["Statistics","Foundations","EDA","Summary-Statistics"]}
---
...
> 3.  **Anscombe's Quartet:** Different datasets can have identical Mean and Variance but look completely different. **Always plot the data** ([[stats/Histogram\|Histogram]], [[stats/Boxplot\|Boxplot]]).
...
- [[stats/Normal Distribution\|Normal Distribution]] - Reference for skew/kurtosis.
- [[stats/Boxplot\|Boxplot]] - Visualizing the 5-number summary.
- [[stats/Outlier Analysis (Standardized Residuals)\|Outlier Analysis (Standardized Residuals)]]
