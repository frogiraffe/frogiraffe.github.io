...
> - Use [[stats/05_Time_Series/Breusch-Godfrey Test\|Breusch-Godfrey Test]] for higher-order autocorrelation (lag > 1).
...
- [ ] **No Lagged DV:** Independent variables cannot include lagged response variables ($Y_{t-1}$). Use [[stats/05_Time_Series/Breusch-Godfrey Test\|Breusch-Godfrey Test]] instead.
