---
{"dg-publish":true,"permalink":"/stats/tukey-s-hsd/","tags":["Statistics","Hypothesis-Testing","Post-Hoc","ANOVA","Multiple-Comparisons"]}
---
...
> **Tukey's HSD (Honestly Significant Difference)** is a **post-hoc test** used after a significant [[stats/One-Way ANOVA\|One-Way ANOVA]] to determine ==which specific group pairs are significantly different==. It controls the **Family-Wise Error Rate (FWER)**, preventing inflation of Type I error from multiple comparisons.
...
> - If you have **specific hypotheses** (not all pairs): Use planned contrasts or [[stats/Bonferroni Correction\|Bonferroni Correction]].
> - If ANOVA assumptions are violated: Use [[stats/Kruskal-Wallis Test\|Kruskal-Wallis Test]] followed by Dunn's test.
...
Inherits assumptions from [[stats/One-Way ANOVA\|One-Way ANOVA]]:
- [ ] Independence.
- [ ] Normality.
...
- [[stats/Bonferroni Correction\|Bonferroni Correction]] - More conservative alternative.
- [[stats/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Non-parametric ANOVA.
