---
{"dg-publish":true,"permalink":"/stats/multiple-linear-regression/","tags":["Statistics","Regression","Linear-Models","OLS","Multiple-Predictors"]}
---
...
All assumptions from [[stats/Simple Linear Regression\|Simple Linear Regression]] apply, plus one critical addition:

- [ ] **Linearity**
- [ ] **Independence**
- [ ] **Normality of Residuals**
- [ ] **Equality of Variance (Homoscedasticity)**
- [ ] **No Multicollinearity:** Predictors ($X$s) should not be highly correlated with each other. (Check: [[stats/VIF (Variance Inflation Factor)\|VIF (Variance Inflation Factor)]]).
...
> 2.  **Overfitting:** Adding too many predictors can make the model fit noise rather than signal. Use [[stats/Ridge Regression\|Ridge Regression]] or [[stats/Lasso Regression\|Lasso Regression]] for regularization.
...
- [[stats/Simple Linear Regression\|Simple Linear Regression]] - The single-predictor case.
- [[stats/VIF (Variance Inflation Factor)\|VIF (Variance Inflation Factor)]] - Multicollinearity diagnostic.
- [[stats/Ridge Regression\|Ridge Regression]] - Regularization to handle multicollinearity.
- [[stats/Lasso Regression\|Lasso Regression]] - Feature selection via L1 penalty.
