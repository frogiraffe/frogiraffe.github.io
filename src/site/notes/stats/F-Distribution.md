---
{"dg-publish":true,"permalink":"/stats/f-distribution/","tags":["Statistics","Probability-Theory","Distributions","ANOVA","Hypothesis-Testing"]}
---
...
3. Compare variance explained by groups in [[stats/One-Way ANOVA\|One-Way ANOVA]].
...
> - [[stats/One-Way ANOVA\|One-Way ANOVA]] - Testing if group means differ.
> - [[stats/Multiple Linear Regression\|Multiple Linear Regression]] - Overall model F-test.
> - **Variance Ratio Test** - Comparing two sample variances.
> - [[stats/Welch's ANOVA\|Welch's ANOVA]] - Modified F-test for unequal variances.
...
- **High df:** Approaches [[stats/Normal Distribution\|Normal Distribution]].
...
The square of a [[stats/T-Distribution\|t-statistic]] with $df$ degrees of freedom is an F-statistic with $(1, df)$ degrees of freedom.
...
- [[stats/One-Way ANOVA\|One-Way ANOVA]] - Primary application.
- [[stats/Chi-Square Distribution\|Chi-Square Distribution]] - F is the ratio of two chi-squares.
- [[stats/T-Distribution\|T-Distribution]] - Related via $t^2 = F(1, df)$.
- [[stats/Levene's Test\|Levene's Test]] - Uses F-like statistic for variance equality.
