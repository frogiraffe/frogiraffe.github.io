---
{"dg-publish":true,"permalink":"/stats/probit-regression/","tags":["Statistics","Regression","GLM","Classification"]}
---
...
> **Probit Regression** is a type of Generalized Linear Model used for binary outcomes, similar to [[stats/Binary Logistic Regression\|Binary Logistic Regression]]. Instead of the logit (log-odds) link, it uses the ==cumulative distribution function (CDF) of the standard normal distribution== ($\Phi$) as the link function.
...
Same as [[stats/Binary Logistic Regression\|Binary Logistic Regression]]:
- [ ] Binary outcome.
...
- [[stats/Binary Logistic Regression\|Binary Logistic Regression]] - The more common alternative.
