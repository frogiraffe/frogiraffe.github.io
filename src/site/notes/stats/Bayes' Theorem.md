---
{"dg-publish":true,"permalink":"/stats/bayes-theorem/","tags":["Statistics","Probability-Theory","Bayesian","Foundations"]}
---
...
> **Bayes' Theorem** is a fundamental result in probability theory that describes how to ==update beliefs== in light of new evidence. It provides the mathematical foundation for [[stats/Bayesian Statistics\|Bayesian Statistics]] and probabilistic reasoning.
...
- [[stats/Bayesian Statistics\|Bayesian Statistics]] - Statistical framework built on Bayes' Theorem.
