...
> The **Mann-Whitney U Test** is a non-parametric test that compares whether two independent groups come from the same distribution. It is the **non-parametric alternative** to the [[stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] when normality cannot be assumed.
...
> - Data is **paired/dependent** — use [[stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]].
> - You have **more than 2 groups** — use [[stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]].
...
> - *Solution:* Use [[stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] for paired data.
>
...
- [[stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] — When normality holds

**Extensions:**
- [[stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] — Paired version
- [[stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] — More than 2 groups

**Effect Size:**
- [[stats/02_Statistical_Inference/Effect Size Measures\|Effect Size]] — Why p-value isn't enough
