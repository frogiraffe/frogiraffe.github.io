---
{"dg-publish":true,"permalink":"/stats/02-statistical-inference/a-b-testing/","tags":["Experimental-Design","Hypothesis-Testing","Business"]}
---
...
-   **Conversion Rate (Probability):** [[stats/02_Statistical_Inference/Z-Test\|Z-Test]] (Two-Proportion) or [[stats/02_Statistical_Inference/Chi-Square Test\|Chi-Square Test]].
-   **Revenue Per User (Mean):** [[stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]].
...
> [!warning] Pitfalls
> 1.  **Peeking (P-Hacking):** Checking p-value every day and stopping when significant. **Solution:** Fix sample size in advance or use [[stats/02_Statistical_Inference/Sequential Testing\|Sequential Testing]].
...
- [[stats/02_Statistical_Inference/Z-Test\|Z-Test]] - The math engine.
- [[stats/02_Statistical_Inference/Power Analysis\|Power Analysis]] - How many users do I need?
