...
> **Two-Way ANOVA** extends [[stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] to examine the effects of ==two independent categorical variables== (factors) on a continuous outcome. It can detect **main effects** of each factor and their **interaction effect**.
...
> - **More than 2 factors:** Use Multi-Way ANOVA or [[stats/02_Statistical_Inference/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]].
> - **Non-normal data:** Use non-parametric alternatives (Aligned Rank Transform ANOVA).
> - **Repeated measures:** Use [[stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]].
...
- [ ] **Homogeneity of Variance:** Equal variances across all factor combinations (check with [[stats/02_Statistical_Inference/Levene's Test\|Levene's Test]]).
...
> 3. **Multiple comparisons:** Post-hoc tests ([[stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]]) are needed if main effects are significant.
...
- [[stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] - Single factor.
- [[stats/02_Statistical_Inference/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]] - Combines between and within factors.
- [[stats/03_Regression_Analysis/Interaction Effects\|Interaction Effects]] - The key addition in Two-Way ANOVA.
- [[stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]] - Post-hoc comparisons.
