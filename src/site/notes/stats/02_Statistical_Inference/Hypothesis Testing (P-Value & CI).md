...
> 2.  **Statistical Significance $\neq$ Practical Significance.** A p-value of 0.001 for a tiny effect (e.g., 0.001 kg weight loss) is meaningless. Always report [[stats/02_Statistical_Inference/Effect Size Measures\|Effect Size Measures]].
> 3.  **Multiple Comparisons Problem:** Running 20 tests at $\alpha = 0.05$ guarantees roughly 1 false positive by chance. Use [[stats/02_Statistical_Inference/Bonferroni Correction\|Bonferroni Correction]] or FDR.
