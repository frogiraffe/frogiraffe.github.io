...
2.  Guide decisions on whether to use robust standard errors or [[stats/03_Regression_Analysis/Weighted Least Squares (WLS)\|Weighted Least Squares (WLS)]].
...
> - Model is [[stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]] or [[stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]].
...
> [!warning] Pitfalls
> 1.  **Sensitive to normality:** Non-normal errors can cause false positives. Use [[stats/03_Regression_Analysis/White Test\|White Test]] for robustness.
