...
3.  Serve as a baseline for more complex count models ([[stats/03_Regression_Analysis/Negative Binomial Regression\|Negative Binomial Regression]], [[stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]]).
...
> - **Variance > Mean** (Overdispersion). Use [[stats/03_Regression_Analysis/Negative Binomial Regression\|Negative Binomial Regression]].
> - **Excess Zeros.** Use [[stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]].
...
> 2.  **Excess Zeros:** Many real datasets have more zeros than Poisson predicts (e.g., "never visited customers"). Use [[stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]].
...
| Dispersion | 2.3 | **Overdispersion**. Variance > Mean. | Standard errors are wrong. Switch to [[stats/03_Regression_Analysis/Negative Binomial Regression\|Negative Binomial Regression]]. |
