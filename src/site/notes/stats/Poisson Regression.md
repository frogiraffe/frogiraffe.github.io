---
{"dg-publish":true,"permalink":"/stats/poisson-regression/","tags":["Statistics","Regression","Classification","GLM","Count-Data"]}
---
...
3.  Serve as a baseline for more complex count models ([[stats/Negative Binomial Regression\|Negative Binomial Regression]], [[stats/Zero-Inflated Models\|Zero-Inflated Models]]).
...
> - **Variance > Mean** (Overdispersion). Use [[stats/Negative Binomial Regression\|Negative Binomial Regression]].
> - **Excess Zeros.** Use [[stats/Zero-Inflated Models\|Zero-Inflated Models]].
...
> 2.  **Excess Zeros:** Many real datasets have more zeros than Poisson predicts (e.g., "never visited customers"). Use [[stats/Zero-Inflated Models\|Zero-Inflated Models]].
...
| Dispersion | 2.3 | **Overdispersion**. Variance > Mean. | Standard errors are wrong. Switch to [[stats/Negative Binomial Regression\|Negative Binomial Regression]]. |
...
- [[stats/Negative Binomial Regression\|Negative Binomial Regression]] - Handles overdispersion.
- [[stats/Zero-Inflated Models\|Zero-Inflated Models]] - Handles excess zeros.
