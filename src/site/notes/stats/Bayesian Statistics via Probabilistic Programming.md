---
{"dg-publish":true,"permalink":"/stats/bayesian-statistics-via-probabilistic-programming/","tags":["Statistics","Bayesian","Machine-Learning","Applied"]}
---
...
> [!abstract] Definition
> This note illustrates the practical application of [[stats/Bayesian Statistics\|Bayesian Statistics]] using modern **Probabilistic Programming** frameworks. It bridges abstract Bayesian theory with computational implementation for real-world inference.
...
- [[stats/Bayesian Statistics\|Bayesian Statistics]] - Theoretical foundations.
- [[stats/Probabilistic Programming\|Probabilistic Programming]] - Framework details.
