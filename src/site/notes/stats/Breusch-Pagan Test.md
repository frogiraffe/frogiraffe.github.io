---
{"dg-publish":true,"permalink":"/stats/breusch-pagan-test/","tags":["Statistics","Diagnostics","Regression","Heteroscedasticity"]}
---
...
2.  Guide decisions on whether to use robust standard errors or [[stats/Weighted Least Squares (WLS)\|Weighted Least Squares (WLS)]].
...
> - Model is [[stats/Simple Linear Regression\|Simple Linear Regression]] or [[stats/Multiple Linear Regression\|Multiple Linear Regression]].
...
> [!warning] Pitfalls
> 1.  **Sensitive to normality:** Non-normal errors can cause false positives. Use [[stats/White Test\|White Test]] for robustness.
...
- [[stats/White Test\|White Test]] - More general heteroscedasticity test.
- [[stats/Weighted Least Squares (WLS)\|Weighted Least Squares (WLS)]] - Correction method.
