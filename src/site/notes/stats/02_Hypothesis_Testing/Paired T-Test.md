---
{"dg-publish":true,"permalink":"/stats/02-hypothesis-testing/paired-t-test/","tags":["Hypothesis-Testing","Parametric","T-Test","Paired-Samples"]}
---
...
> - Samples are **independent** (use [[stats/02_Hypothesis_Testing/Student's T-Test\|Student's T-Test]] instead).
> - You have **more than 2 related groups** (use [[stats/02_Hypothesis_Testing/Repeated Measures ANOVA\|Repeated Measures ANOVA]]).
> - Differences are **severely non-normal** with small sample size (use [[stats/02_Hypothesis_Testing/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]]).
> - Outcome is **categorical** (use [[stats/02_Hypothesis_Testing/McNemar's Test\|McNemar's Test]]).
...
**Prerequisites:**
- [[stats/02_Hypothesis_Testing/Student's T-Test\|Student's T-Test]] — Independent samples version
- [[stats/01_Foundations/T-Distribution\|T-Distribution]]
- [[stats/01_Foundations/Standard Error\|Standard Error]]

**Alternatives:**
- [[stats/02_Hypothesis_Testing/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] — Non-parametric alternative when normality fails
