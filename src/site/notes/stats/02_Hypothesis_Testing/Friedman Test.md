---
{"dg-publish":true,"permalink":"/stats/02-hypothesis-testing/friedman-test/","tags":["Hypothesis-Testing","Non-Parametric","Repeated-Measures","ANOVA-Alternative"]}
---
...
> The **Friedman Test** is a non-parametric alternative to [[stats/02_Hypothesis_Testing/Repeated Measures ANOVA\|Repeated Measures ANOVA]] for comparing ==three or more related groups==. It uses ranks instead of raw values, making it robust to non-normality and outliers.
...
> - Groups are **independent** (use [[stats/02_Hypothesis_Testing/Kruskal-Wallis Test\|Kruskal-Wallis Test]]).
> - Only **2 related groups** (use [[stats/02_Hypothesis_Testing/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]]).
> - Data is **normal** with equal variances (use [[stats/02_Hypothesis_Testing/Repeated Measures ANOVA\|Repeated Measures ANOVA]] for more power).
...
> 
> **Correct Test:** Use [[stats/02_Hypothesis_Testing/Kruskal-Wallis Test\|Kruskal-Wallis Test]] for independent groups.
> 
> **Rule:** 
...
**Prerequisites:**
- [[stats/02_Hypothesis_Testing/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] - 2 related groups version
- [[stats/02_Hypothesis_Testing/Repeated Measures ANOVA\|Repeated Measures ANOVA]] - Parametric alternative

**Comparisons:**
- [[stats/02_Hypothesis_Testing/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Independent groups version
- [[stats/02_Hypothesis_Testing/One-Way ANOVA\|One-Way ANOVA]] - Parametric for independent groups

**Post-Hoc Tests:**
- [[stats/02_Hypothesis_Testing/Tukey's HSD\|Tukey's HSD]] - Parametric alternative
