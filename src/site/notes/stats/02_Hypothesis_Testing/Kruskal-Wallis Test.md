...
> The **Kruskal-Wallis H Test** is the non-parametric alternative to [[stats/02_Hypothesis_Testing/One-Way ANOVA\|One-Way ANOVA]]. It compares the rank distributions of ==three or more independent groups== to determine if at least one group differs.
