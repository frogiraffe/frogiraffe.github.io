...
> - Group **variances are equal** ([[stats/02_Hypothesis_Testing/Levene's Test\|Levene's Test]] $p > 0.05$).

> [!failure] Use Alternatives When...
> - Variances are **unequal**: Use [[stats/02_Hypothesis_Testing/Welch's T-Test\|Welch's T-Test]].
> - Data is **not normal** and $n$ is small: Use [[stats/02_Hypothesis_Testing/Mann-Whitney U Test\|Mann-Whitney U Test]].
> - **Three or more groups**: Use [[stats/02_Hypothesis_Testing/One-Way ANOVA\|One-Way ANOVA]].
...
- [ ] **Normality:** Data in each group is approximately normally distributed. (Check: [[stats/02_Hypothesis_Testing/Shapiro-Wilk Test\|Shapiro-Wilk Test]], [[stats/08_Visualization/Q-Q Plot\|Q-Q Plot]]). Robust if $n > 30$.
- [ ] ==**Homogeneity of Variance:**== Variances are equal across groups. (Check: [[stats/02_Hypothesis_Testing/Levene's Test\|Levene's Test]]). If violated, use [[stats/02_Hypothesis_Testing/Welch's T-Test\|Welch's T-Test]].
...
> 3.  **Effect Size:** A significant p-value does not mean a *large* difference. Always report [[stats/02_Hypothesis_Testing/Effect Size Measures\|Effect Size Measures]] (Cohen's d).
...
- [[stats/02_Hypothesis_Testing/Welch's T-Test\|Welch's T-Test]] - Robust to unequal variances.
