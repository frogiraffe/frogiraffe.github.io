...
> **Tukey's HSD (Honestly Significant Difference)** is a **post-hoc test** used after a significant [[stats/02_Hypothesis_Testing/One-Way ANOVA\|One-Way ANOVA]] to determine ==which specific group pairs are significantly different==. It controls the **Family-Wise Error Rate (FWER)**, preventing inflation of Type I error from multiple comparisons.
...
> - If you have **specific hypotheses** (not all pairs): Use planned contrasts or [[stats/02_Hypothesis_Testing/Bonferroni Correction\|Bonferroni Correction]].
> - If ANOVA assumptions are violated: Use [[stats/02_Hypothesis_Testing/Kruskal-Wallis Test\|Kruskal-Wallis Test]] followed by Dunn's test.
...
Inherits assumptions from [[stats/02_Hypothesis_Testing/One-Way ANOVA\|One-Way ANOVA]]:
- [ ] Independence.
- [ ] Normality.
