...
> - **Variances are approximately equal** across groups ([[stats/02_Hypothesis_Testing/Levene's Test\|Levene's Test]]).

> [!failure] Alternatives
> - **Unequal variances:** [[stats/02_Hypothesis_Testing/Welch's ANOVA\|Welch's ANOVA]].
> - **Non-normal data:** [[stats/02_Hypothesis_Testing/Kruskal-Wallis Test\|Kruskal-Wallis Test]].
> - **Two groups:** [[stats/02_Hypothesis_Testing/Student's T-Test\|Student's T-Test]] or [[stats/02_Hypothesis_Testing/Welch's T-Test\|Welch's T-Test]].
...
> A significant ANOVA result only indicates that ==at least one group differs==. To find *which* groups differ, you must run **Post-Hoc Tests** (e.g., [[stats/02_Hypothesis_Testing/Tukey's HSD\|Tukey's HSD]]).
...
- [ ] **Normality:** Data within each group is normally distributed. (Check per-group: [[stats/02_Hypothesis_Testing/Shapiro-Wilk Test\|Shapiro-Wilk Test]]).
- [ ] ==**Homogeneity of Variance:**== Variances are equal across groups. (Check: [[stats/02_Hypothesis_Testing/Levene's Test\|Levene's Test]]). If violated, use [[stats/02_Hypothesis_Testing/Welch's ANOVA\|Welch's ANOVA]].
...
- [[stats/02_Hypothesis_Testing/Welch's ANOVA\|Welch's ANOVA]] - Robust to unequal variances.
- [[stats/02_Hypothesis_Testing/Tukey's HSD\|Tukey's HSD]] - Post-hoc pairwise comparisons.
