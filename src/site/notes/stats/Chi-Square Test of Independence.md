---
{"dg-publish":true,"permalink":"/stats/chi-square-test-of-independence/","tags":["Statistics","Hypothesis-Testing","Categorical-Data","Non-Parametric"]}
---
...
> - **Expected counts < 5:** Use [[stats/Fisher's Exact Test\|Fisher's Exact Test]].
...
> [!warning] Pitfalls
> 1.  **Sensitive to Sample Size:** With very large $n$, even trivial associations become significant. Report [[stats/Effect Size Measures\|Cramer's V]].
...
- [[stats/Fisher's Exact Test\|Fisher's Exact Test]] - For small expected counts.
- [[stats/Effect Size Measures\|Effect Size Measures]] - Cramer's V.
- [[stats/Logistic Regression\|Logistic Regression]] - For modeling categorical outcomes.