---
{"dg-publish":true,"permalink":"/stats/bernoulli-distribution/","tags":["Statistics","Probability-Theory","Distributions","Discrete"]}
---
...
1.  **Building Block:** It is the fundamental atom of probability.
    -   $n$ Bernoulli trials $\to$ **[[stats/Binomial Distribution\|Binomial Distribution]]**.
...
- [[stats/Binomial Distribution\|Binomial Distribution]] - Sum of $n$ Bernoullis.
- [[stats/Logistic Regression\|Logistic Regression]] - Modeling outcomes using Bernoulli likelihood.
