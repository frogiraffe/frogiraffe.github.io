---
{"dg-publish":true,"permalink":"/stats/stationarity-adf-and-kpss/","tags":["Statistics","Time-Series","Diagnostics","Stationarity"]}
---
...
> A time series is **Stationary** if its statistical properties (mean, variance, autocorrelation) ==do not change over time==. Stationarity is a **prerequisite** for many time series models like [[stats/ARIMA Models\|ARIMA Models]].
...
- [[stats/ARIMA Models\|ARIMA Models]] - Requires stationarity.
- [[Differencing\|Differencing]] - Transformation to achieve stationarity.
- [[stats/GARCH Models\|GARCH Models]] - For non-constant variance.
