---
{"dg-publish":true,"permalink":"/stats/durbin-watson-test/","tags":["Statistics","Diagnostics","Time-Series","Regression","Autocorrelation"]}
---
...
> The **Durbin-Watson (DW) Test** detects **autocorrelation** (or serial correlation) in the residuals of a regression analysis. It tests whether adjacent residuals are correlated, which violates the assumption of independence in [[stats/Simple Linear Regression\|Simple Linear Regression]].
...
> - Use [[stats/Breusch-Godfrey Test\|Breusch-Godfrey Test]] for higher-order autocorrelation (lag > 1).
...
- [ ] **No Lagged DV:** Independent variables cannot include lagged response variables ($Y_{t-1}$). Use [[stats/Breusch-Godfrey Test\|Breusch-Godfrey Test]] instead.
...
- [[stats/Breusch-Godfrey Test\|Breusch-Godfrey Test]] - More general test for AR(p) errors.
