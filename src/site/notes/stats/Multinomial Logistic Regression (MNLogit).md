---
{"dg-publish":true,"permalink":"/stats/multinomial-logistic-regression-mn-logit/","tags":["Statistics","Regression","GLM","Classification","Multiclass"]}
---
...
> **Multinomial Logistic Regression (MNLogit)** extends [[stats/Binary Logistic Regression\|Binary Logistic Regression]] to handle outcomes with ==more than two unordered categories== (e.g., Transportation Mode: Car, Bus, Bike). It models the probability of each category relative to a **reference category**.
...
> - Outcome is binary (use [[stats/Binary Logistic Regression\|Binary Logistic Regression]]).
...
- [[stats/Binary Logistic Regression\|Binary Logistic Regression]]
