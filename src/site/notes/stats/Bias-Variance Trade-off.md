---
{"dg-publish":true,"permalink":"/stats/bias-variance-trade-off/","tags":["Statistics","Machine-Learning","Model-Selection","Foundations"]}
---
...
- How do regularization methods ([[stats/Ridge Regression\|Ridge Regression]], [[stats/Lasso Regression\|Lasso Regression]]) help?
...
| **High Variance (Overfitting)** | Use [[stats/Cross-Validation\|Cross-Validation]], add [[stats/Ridge Regression\|Ridge Regression]]/[[stats/Lasso Regression\|Lasso Regression]], reduce features, collect more data. |
...
- [[stats/Cross-Validation\|Cross-Validation]] - Detects overfitting.
- [[stats/Ridge Regression\|Ridge Regression]] / [[stats/Lasso Regression\|Lasso Regression]] - Reduce variance.
