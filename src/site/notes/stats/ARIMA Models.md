---
{"dg-publish":true,"permalink":"/stats/arima-models/","tags":["Statistics","Time-Series","Forecasting","Econometrics"]}
---
...
> - **Multiple predictors:** Use [[stats/Vector Autoregression (VAR)\|Vector Autoregression (VAR)]] or regression.
> - **Volatility clustering:** Use [[stats/GARCH Models\|GARCH Models]].
...
2.  **Test Stationarity:** [[stats/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]]. Apply differencing if needed.
...
- [[stats/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Prerequisite.
- [[stats/Vector Autoregression (VAR)\|Vector Autoregression (VAR)]] - Multivariate extension.
- [[stats/GARCH Models\|GARCH Models]] - For volatility.
- [[stats/Granger Causality\|Granger Causality]] - Testing predictive relationships.
