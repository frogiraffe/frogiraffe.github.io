---
{"dg-publish":true,"permalink":"/stats/cook-s-distance/","tags":["Statistics","Diagnostics","Regression","Outliers","Influential-Points"]}
---
...
- [[stats/Leverage (Hat Matrix)\|Leverage (Hat Matrix)]] - Potential for influence.
- [[Robust Regression\|Robust Regression]] - Alternative that downweights outliers (e.g., RANSAC, Huber).
- [[stats/VIF (Variance Inflation Factor)\|VIF (Variance Inflation Factor)]]