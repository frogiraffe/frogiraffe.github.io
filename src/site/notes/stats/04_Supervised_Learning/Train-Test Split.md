...
> **Train-Test Split** is a fundamental technique in machine learning where data is divided into two subsets: a ==training set== (to fit the model) and a ==test set== (to evaluate performance). This prevents [[stats/04_Supervised_Learning/Overfitting & Underfitting\|overfitting]] by assessing generalization to unseen data.
...
> - **Small datasets:** Use [[stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] instead (more efficient use of data).
...
> 4. **Small Data:** Single split has high variance. Use [[stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]].
...
- [[stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] - More robust alternative for small data.
