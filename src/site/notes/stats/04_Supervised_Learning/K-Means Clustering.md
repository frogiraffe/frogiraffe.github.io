---
{"dg-publish":true,"permalink":"/stats/04-supervised-learning/k-means-clustering/","tags":["Machine-Learning","Clustering","Unsupervised-Learning"]}
---
...
> 3.  **High Dimensions:** In very high dimensions, Euclidean distance loses meaning (Curse of Dimensionality). Use [[stats/04_Supervised_Learning/Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]] first.
...
- [[stats/04_Supervised_Learning/Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]] - Often used before K-means.
- [[stats/01_Foundations/DBSCAN\|DBSCAN]] - Alternative clustering for irregular shapes.
- [[stats/04_Supervised_Learning/Hierarchical Clustering\|Hierarchical Clustering]] - Alternative that builds a tree.
