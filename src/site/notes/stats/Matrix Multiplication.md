---
{"dg-publish":true,"permalink":"/stats/matrix-multiplication/","tags":["Math","Linear-Algebra","Foundations"]}
---
...
- [[stats/Eigenvalues & Eigenvectors\|Eigenvalues & Eigenvectors]] - What vectors stay the same after multiplication?
- [[stats/Principal Component Analysis (PCA)\|Principal Component Analysis (PCA)]] - Uses correlation matrix ($X^T X$).
- [[stats/Multiple Linear Regression\|Multiple Linear Regression]] - Solution involves $(X^T X)^{-1} X^T y$.
