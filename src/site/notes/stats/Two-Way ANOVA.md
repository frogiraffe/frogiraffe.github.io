---
{"dg-publish":true,"permalink":"/stats/two-way-anova/","tags":["Statistics","Hypothesis-Testing","ANOVA","Factorial-Design","Parametric-Tests"]}
---
...
> **Two-Way ANOVA** extends [[stats/One-Way ANOVA\|One-Way ANOVA]] to examine the effects of ==two independent categorical variables== (factors) on a continuous outcome. It can detect **main effects** of each factor and their **interaction effect**.
...
> - **More than 2 factors:** Use Multi-Way ANOVA or [[stats/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]].
> - **Non-normal data:** Use non-parametric alternatives (Aligned Rank Transform ANOVA).
> - **Repeated measures:** Use [[stats/Repeated Measures ANOVA\|Repeated Measures ANOVA]].
...
- [ ] **Homogeneity of Variance:** Equal variances across all factor combinations (check with [[stats/Levene's Test\|Levene's Test]]).
...
> 3. **Multiple comparisons:** Post-hoc tests ([[stats/Tukey's HSD\|Tukey's HSD]]) are needed if main effects are significant.
...
- [[stats/One-Way ANOVA\|One-Way ANOVA]] - Single factor.
- [[stats/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]] - Combines between and within factors.
- [[Interaction Effects\|Interaction Effects]] - The key addition in Two-Way ANOVA.
- [[stats/Tukey's HSD\|Tukey's HSD]] - Post-hoc comparisons.
