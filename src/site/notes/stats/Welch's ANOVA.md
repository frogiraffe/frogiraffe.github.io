---
{"dg-publish":true,"permalink":"/stats/welch-s-anova/","tags":["Statistics","Hypothesis-Testing","ANOVA"]}
---
...
> [!abstract] Definition
> **Welch's ANOVA** is a robust alternative to standard [[stats/One-Way ANOVA\|One-Way ANOVA]] used when the assumption of **homogeneity of variances** is violated. It adjusts the F-statistic and degrees of freedom to account for unequal variances across groups, reducing the risk of Type I errors.
...
- [[stats/One-Way ANOVA\|One-Way ANOVA]] - The standard technique assuming equal variances.
- [[stats/Levene's Test\|Levene's Test]] - Diagnostic for variance homogeneity.
- [[stats/Welch's T-Test\|Welch's T-Test]] - The two-group equivalent of Welch's ANOVA.
- [[stats/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Non-parametric alternative when normality is also violated.
