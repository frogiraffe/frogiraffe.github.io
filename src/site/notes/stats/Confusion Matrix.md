---
{"dg-publish":true,"permalink":"/stats/confusion-matrix/","tags":["Statistics","Classification","Machine-Learning","Model-Evaluation","Metrics"]}
---
...
> 2.  **Threshold Dependent:** Metrics change with the classification threshold. Use [[stats/ROC & AUC\|ROC & AUC]] for threshold-independent evaluation.
...
- [[stats/ROC & AUC\|ROC & AUC]] - Threshold-independent performance.
- [[stats/Binary Logistic Regression\|Binary Logistic Regression]] - Typical model producing these outputs.
