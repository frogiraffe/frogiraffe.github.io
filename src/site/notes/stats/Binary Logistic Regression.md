---
{"dg-publish":true,"permalink":"/stats/binary-logistic-regression/","tags":["Statistics","Regression","Classification","GLM","Binary-Outcome"]}
---
...
> - Outcome has more than 2 categories (use [[stats/Multinomial Logistic Regression (MNLogit)\|Multinomial Logistic Regression (MNLogit)]] or [[Ordinal Logistic Regression\|Ordinal Logistic Regression]]).
> - Outcome is a count (use [[stats/Poisson Regression\|Poisson Regression]]).
...
| **[[stats/ROC & AUC\|ROC & AUC]]** | Discrimination ability. Area under curve; 0.7-0.8 acceptable, >0.8 excellent. |
| **[[stats/Confusion Matrix\|Confusion Matrix]]** | Accuracy, Precision, Recall at a given threshold. |
| **[[stats/Hosmer-Lemeshow Test\|Hosmer-Lemeshow Test]]** | Calibration; do predicted probabilities match observed rates? |
...
- [[stats/Logistic Regression\|Logistic Regression]] - Family overview.
- [[stats/Maximum Likelihood Estimation (MLE)\|Maximum Likelihood Estimation (MLE)]]
- [[stats/ROC & AUC\|ROC & AUC]] - Performance metric.
- [[stats/Confusion Matrix\|Confusion Matrix]] - Classification metrics.
- [[stats/Probit Regression\|Probit Regression]] - Alternative using normal CDF.