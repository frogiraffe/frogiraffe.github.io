---
{"dg-publish":true,"permalink":"/stats/standard-error/","tags":["Statistics","Foundations","Inference","Sampling"]}
---
...
2. Construct [[stats/Confidence Intervals\|Confidence Intervals]].
...
where:
- $s$ = sample [[stats/Standard Deviation\|Standard Deviation]]
- $n$ = sample size
...
> - SE captures the [[stats/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]]: as $n$ increases, the sampling distribution narrows.
...
- [ ] For small $n$: **Normality** (or use [[stats/T-Distribution\|T-Distribution]]).
...
- [[stats/Standard Deviation\|Standard Deviation]] - Variability in data.
- [[stats/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]] - Why SE exists.
- [[stats/Confidence Intervals\|Confidence Intervals]] - Built from SE.
- [[stats/T-Distribution\|T-Distribution]] - Used with SE when $\sigma$ unknown.
