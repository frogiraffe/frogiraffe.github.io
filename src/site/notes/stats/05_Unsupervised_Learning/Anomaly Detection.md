...
| Method | Mechanism |
|--------|-----------|
| **[[stats/05_Unsupervised_Learning/Gaussian Mixture Models\|Gaussian Mixture Models]]** | Low probability under mixture = anomaly |
| **[[stats/01_Foundations/Kernel Density Estimation\|Kernel Density Estimation]]** | Low density regions are anomalous |
...
> - *Solution:* Use [[stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA]] or [[stats/05_Unsupervised_Learning/t-SNE & UMAP\|t-SNE & UMAP]] for dimensionality reduction first
>
> **4. Concept Drift**
...
**Prerequisites:**
- [[stats/01_Foundations/Euclidean Distance\|Euclidean Distance]] — Basis for distance-based methods
- [[stats/01_Foundations/Normal Distribution\|Normal Distribution]] — Statistical approach foundation
- [[stats/01_Foundations/Kernel Density Estimation\|Kernel Density Estimation]] — Density estimation basis

**Extensions:**
- [[stats/05_Unsupervised_Learning/Autoencoders\|Autoencoders]] — Reconstruction-based anomaly detection
- [[stats/05_Unsupervised_Learning/Gaussian Mixture Models\|Gaussian Mixture Models]] — Probabilistic anomaly scoring

**Applications:**
- [[stats/08_Time_Series_Analysis/Time Series Analysis\|Time Series Analysis]] — Temporal anomaly detection
