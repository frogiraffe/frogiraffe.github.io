...
1. **Dimensionality Reduction:** Non-linear alternative to [[stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA]]
2. **Feature Learning:** Learn useful representations for downstream tasks
3. **[[stats/05_Unsupervised_Learning/Anomaly Detection\|Anomaly Detection]]:** High reconstruction error indicates outliers
...
**Alternatives:**
- [[stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] — Linear dimensionality reduction
- [[stats/05_Unsupervised_Learning/t-SNE & UMAP\|t-SNE & UMAP]] — Non-linear visualization (not generative)

**Extensions:**
- [[stats/05_Unsupervised_Learning/Anomaly Detection\|Anomaly Detection]] — Using reconstruction error
- [[stats/05_Unsupervised_Learning/Gaussian Mixture Models\|Gaussian Mixture Models]] — Alternative generative model
