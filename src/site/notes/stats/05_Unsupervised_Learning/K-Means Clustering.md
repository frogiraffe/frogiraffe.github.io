...
- [[stats/05_Unsupervised_Learning/Hierarchical Clustering\|Hierarchical Clustering]] - An alternative that doesn't require pre-defining $K$.
- [[stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] - Often used before clustering to reduce noise.
- [[stats/01_Foundations/Euclidean Distance\|Euclidean Distance]] - The standard distance metric used.
