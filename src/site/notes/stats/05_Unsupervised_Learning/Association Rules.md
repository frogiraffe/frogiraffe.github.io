...
**Prerequisites:**
- [[stats/01_Foundations/Conditional Probability\|Conditional Probability]] — Confidence is P(Y|X)
- Set theory (unions, intersections)

**Extensions:**
- Sequential Pattern Mining — Time-ordered associations
- [[stats/05_Unsupervised_Learning/Anomaly Detection\|Anomaly Detection]] — Unusual transaction patterns

**Applications:**
- Recommendation systems
- [[stats/02_Statistical_Inference/A-B Testing\|A-B Testing]] — Testing product placement changes
