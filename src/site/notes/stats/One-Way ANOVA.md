---
{"dg-publish":true,"permalink":"/stats/one-way-anova/","tags":["Statistics","Hypothesis-Testing","Parametric-Tests","Mean-Comparison","ANOVA"]}
---
...
> - **Variances are approximately equal** across groups ([[stats/Levene's Test\|Levene's Test]]).

> [!failure] Alternatives
> - **Unequal variances:** [[stats/Welch's ANOVA\|Welch's ANOVA]].
> - **Non-normal data:** [[stats/Kruskal-Wallis Test\|Kruskal-Wallis Test]].
> - **Two groups:** [[stats/Student's T-Test\|Student's T-Test]] or [[stats/Welch's T-Test\|Welch's T-Test]].
...
> A significant ANOVA result only indicates that ==at least one group differs==. To find *which* groups differ, you must run **Post-Hoc Tests** (e.g., [[stats/Tukey's HSD\|Tukey's HSD]]).
...
- [ ] **Normality:** Data within each group is normally distributed. (Check per-group: [[stats/Shapiro-Wilk Test\|Shapiro-Wilk Test]]).
- [ ] ==**Homogeneity of Variance:**== Variances are equal across groups. (Check: [[stats/Levene's Test\|Levene's Test]]). If violated, use [[stats/Welch's ANOVA\|Welch's ANOVA]].
...
- [[stats/Welch's ANOVA\|Welch's ANOVA]] - Robust to unequal variances.
- [[stats/Tukey's HSD\|Tukey's HSD]] - Post-hoc pairwise comparisons.
- [[stats/Bonferroni Correction\|Bonferroni Correction]] - Alternative multiple comparison adjustment.
- [[stats/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Non-parametric alternative.
- [[stats/MANOVA\|MANOVA]] - Multiple dependent variables.