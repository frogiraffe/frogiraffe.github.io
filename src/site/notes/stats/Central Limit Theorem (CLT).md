---
{"dg-publish":true,"permalink":"/stats/central-limit-theorem-clt/","tags":["Statistics","Probability-Theory","Foundations","Sampling"]}
---
...
1.  Using Z-scores and T-scores to calculate [[stats/Confidence Intervals\|Confidence Intervals]].
...
- [[stats/Normal Distribution\|Normal Distribution]] - The target distribution.
- [[stats/Law of Large Numbers\|Law of Large Numbers]] - Related but distinct (LLN is about accuracy, CLT is about distribution shape).
- [[stats/Standard Error\|Standard Error]] - Derived directly from CLT.
- [[stats/T-Distribution\|T-Distribution]] - Used when $\sigma$ is unknown.
- [[stats/Confidence Intervals\|Confidence Intervals]] - Built on CLT logic.
