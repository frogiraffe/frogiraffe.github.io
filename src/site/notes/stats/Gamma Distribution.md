---
{"dg-publish":true,"permalink":"/stats/gamma-distribution/","tags":["Statistics","Probability-Theory","Distributions","Continuous","Reliability"]}
---
...
> The **Gamma Distribution** models the time until **$k$ events** occur in a Poisson process. It is a generalization of the [[stats/Exponential Distribution\|Exponential Distribution]] (which models time until *1* event). It is defined by shape parameter $k$ (or $\alpha$) and scale parameter $\theta$ (or rate $\beta$).
...
- [[stats/Exponential Distribution\|Exponential Distribution]] - Special case ($k=1$).
- [[stats/Poisson Distribution\|Poisson Distribution]] - Counts events in fixed time (Dual concept).
- [[stats/Chi-Square Distribution\|Chi-Square Distribution]] - Another special case.
- [[stats/Beta Distribution\|Beta Distribution]] - Associated conjugate prior.
