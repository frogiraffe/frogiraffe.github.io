---
{"dg-publish":true,"permalink":"/stats/simple-linear-regression/","tags":["Statistics","Regression","Linear-Models","OLS","Prediction"]}
---
...
> - You have multiple predictors (use [[stats/Multiple Linear Regression\|Multiple Linear Regression]]).
> - The outcome is categorical (use [[stats/Logistic Regression\|Logistic Regression]]).
...
> - [ ] **I**ndependence: Observations are independent. (Check: [[stats/Durbin-Watson Test\|Durbin-Watson Test]] for time series).
> - [ ] **N**ormality: ==Residuals== (not $Y$!) are normally distributed. (Check: [[stats/Q-Q Plot\|Q-Q Plot]], [[stats/Shapiro-Wilk Test\|Shapiro-Wilk Test]]).
> - [ ] **E**qual Variance (Homoscedasticity): The variance of residuals is constant across all $X$. (Check: [[stats/Breusch-Pagan Test\|Breusch-Pagan Test]], Residual vs Fitted plot).
...
> 2.  **Sensitive to Outliers:** Extreme points can disproportionately influence the slope and $R^2$. Check [[stats/Cook's Distance\|Cook's Distance]].
...
- [[stats/Multiple Linear Regression\|Multiple Linear Regression]] - More than one predictor.
- [[stats/Pearson Correlation\|Pearson Correlation]] - Related but different (Correlation $\neq$ Slope).
- [[Residual Analysis\|Residual Analysis]] - Checking assumptions.
- [[stats/Cook's Distance\|Cook's Distance]] - Identifying influential observations.