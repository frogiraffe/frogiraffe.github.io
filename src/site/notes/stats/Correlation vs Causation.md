---
{"dg-publish":true,"permalink":"/stats/correlation-vs-causation/","tags":["Statistics","Foundations","Causal-Inference","Critical-Thinking"]}
---
...
> - **Quasi-experimental designs** ([[stats/Instrumental Variables (IV)\|Instrumental Variables (IV)]], [[stats/Difference-in-Differences (DiD)\|Difference-in-Differences (DiD)]], [[stats/Regression Discontinuity Design (RDD)\|Regression Discontinuity Design (RDD)]]).
...
| [[stats/Instrumental Variables (IV)\|Instrumental Variables (IV)]] | Identifies causal effect with natural experiment. | Finding valid instruments is hard. |
| [[stats/Propensity Score Matching (PSM)\|Propensity Score Matching (PSM)]] | Balances observed confounders. | Cannot control unobserved confounders. |
| [[stats/Difference-in-Differences (DiD)\|Difference-in-Differences (DiD)]] | Removes time-invariant confounders. | Assumes parallel trends. |
...
- [[stats/Instrumental Variables (IV)\|Instrumental Variables (IV)]] - Causal inference method.
