---
{"dg-publish":true,"permalink":"/stats/propensity-score-matching-psm/","tags":["Statistics","Causal-Inference","Econometrics","Observational-Studies"]}
---
...
1.  **Estimate Scores:** Fit [[stats/Binary Logistic Regression\|Binary Logistic Regression]] with Treatment as outcome, covariates as predictors.
...
- [[stats/Binary Logistic Regression\|Binary Logistic Regression]] - Estimates propensity score.
- [[stats/Instrumental Variables (IV)\|Instrumental Variables (IV)]] - Alternative for endogeneity.
