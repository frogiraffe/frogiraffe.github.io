---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/uniform-distribution/","tags":["probability","foundations"]}
---
...
3. Serve as a **non-informative prior** in [[30_Knowledge/Stats/01_Foundations/Bayesian Statistics\|Bayesian Statistics]]
...
> - Generating random samples for [[30_Knowledge/Stats/01_Foundations/Monte Carlo Simulation\|Monte Carlo Simulation]]
...
> - **Discrete outcomes:** Use [[30_Knowledge/Stats/01_Foundations/Discrete Uniform Distribution\|Discrete Uniform Distribution]] (e.g., dice)
...
### Directly Related
- [[30_Knowledge/Stats/01_Foundations/Discrete Uniform Distribution\|Discrete Uniform Distribution]] - For discrete outcomes (e.g., dice)
- [[30_Knowledge/Stats/01_Foundations/Bayesian Statistics\|Bayesian Statistics]] - Uniform used as non-informative prior
- [[30_Knowledge/Stats/01_Foundations/Monte Carlo Simulation\|Monte Carlo Simulation]] - Random number generation

### Contrast With
- [[30_Knowledge/Stats/01_Foundations/Normal Distribution\|Normal Distribution]] - Uniform is the opposite (flat vs bell)
- [[30_Knowledge/Stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] - Has decay structure
