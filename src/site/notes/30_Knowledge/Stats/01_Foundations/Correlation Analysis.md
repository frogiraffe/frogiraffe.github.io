---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/correlation-analysis/","tags":["probability","foundations"]}
---
...
> - Checking assumptions before [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|regression]]
...
### Directly Related
- [[30_Knowledge/Stats/01_Foundations/Covariance\|Covariance]] - Unstandardized version
- [[30_Knowledge/Stats/02_Statistical_Inference/Pearson Correlation\|Pearson Correlation]] - Most common type
- [[30_Knowledge/Stats/02_Statistical_Inference/Spearman's Rank Correlation\|Spearman's Rank Correlation]] - For ordinal/non-linear

### Applications
- [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]] - Uses r to measure fit
- [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]] - Multicollinearity check
- [[30_Knowledge/Stats/01_Foundations/Feature Selection\|Feature Selection]] - Screen features
...
2. Agresti, A., & Finlay, B. (2010). *Statistical Methods for the Social Sciences* (4th ed.). Pearson.
