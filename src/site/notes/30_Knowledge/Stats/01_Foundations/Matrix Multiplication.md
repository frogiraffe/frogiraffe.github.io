---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/matrix-multiplication/","tags":["probability","foundations"]}
---
...
- [[30_Knowledge/Stats/01_Foundations/Eigenvalues & Eigenvectors\|Eigenvalues & Eigenvectors]] - What vectors stay the same after multiplication?
- [[30_Knowledge/Stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] - Uses correlation matrix ($X^T X$).
- [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]] - Solution involves $(X^T X)^{-1} X^T y$.

---

## When to Use

> [!success] Use Matrix Multiplication When...
