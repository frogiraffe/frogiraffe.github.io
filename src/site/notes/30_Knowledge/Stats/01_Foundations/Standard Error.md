---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/standard-error/","tags":["probability","foundations"]}
---
...
2. Construct [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]].
...
where:
- $s$ = sample [[30_Knowledge/Stats/01_Foundations/Standard Deviation\|Standard Deviation]]
- $n$ = sample size
...
> - SE captures the [[30_Knowledge/Stats/01_Foundations/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]]: as $n$ increases, the sampling distribution narrows.
...
- [ ] For small $n$: **Normality** (or use [[30_Knowledge/Stats/01_Foundations/T-Distribution\|T-Distribution]]).
...
- [[30_Knowledge/Stats/01_Foundations/Standard Deviation\|Standard Deviation]] - Variability in data.
- [[30_Knowledge/Stats/01_Foundations/Central Limit Theorem (CLT)\|Central Limit Theorem (CLT)]] - Why SE exists.
- [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]] - Built from SE.
- [[30_Knowledge/Stats/01_Foundations/T-Distribution\|T-Distribution]] - Used with SE when $\sigma$ unknown.
