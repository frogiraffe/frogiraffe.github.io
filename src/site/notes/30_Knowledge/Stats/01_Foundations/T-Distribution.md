---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/t-distribution/","tags":["probability","foundations"]}
---
...
1.  **Constructing [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]]** for the mean when $\sigma$ is unknown.
2.  **Hypothesis Testing** ([[30_Knowledge/Stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]], [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]]) comparing means.
3.  **Regression Inference** - Coefficients in [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]] are t-distributed under $H_0$.
...
> - **Severely skewed data:** Especially with small $n$. Use [[30_Knowledge/Stats/02_Statistical_Inference/Mann-Whitney U Test\|Mann-Whitney U Test]] or [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]].
> - **Heavy outliers:** The sample mean and SD are distorted. Use robust methods or bootstrap.
> - **Known population σ:** Use [[30_Knowledge/Stats/01_Foundations/Normal Distribution\|Normal Distribution]] (Z-scores) directly.
...
- [ ] **Normality:** The population from which the sample is drawn is approximately normal.
  ...
  - *Note:* Robust if $n$ is large due to [[30_Knowledge/Stats/01_Foundations/Central Limit Theorem (CLT)\|CLT]].
...
> [!warning] Pitfalls
> 1.  **Skewed Data in Small Samples:** If $n=10$ and the data is highly skewed (e.g., reaction times), the t-distribution is **not valid** and CIs will be incorrect. Use bootstrapping or [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]].
...
### Directly Related
- [[30_Knowledge/Stats/01_Foundations/Normal Distribution\|Normal Distribution]] - The ideal scenario (known $\sigma$)
- [[30_Knowledge/Stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] - Primary application
- [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]] - Calculated using t-scores
- [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]] - Robust version when variances differ
- [[30_Knowledge/Stats/02_Statistical_Inference/Degrees of Freedom\|Degrees of Freedom]] - The shape parameter

### Theoretically Related
- [[30_Knowledge/Stats/01_Foundations/Chi-Square Distribution\|Chi-Square Distribution]] - Used in t-distribution definition
- [[30_Knowledge/Stats/01_Foundations/F-Distribution\|F-Distribution]] - Ratio of two chi-squares (related to t²)
