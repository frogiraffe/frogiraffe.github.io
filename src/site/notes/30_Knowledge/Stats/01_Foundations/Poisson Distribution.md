---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/poisson-distribution/","tags":["probability","foundations"]}
---
...
2.  Baseline model for **Count Regression** ([[30_Knowledge/Stats/03_Regression_Analysis/Poisson Regression\|Poisson Regression]]).
3.  Approximation for [[30_Knowledge/Stats/01_Foundations/Binomial Distribution\|Binomial Distribution]] when $n$ is large and $p$ is small.
...
> - **Overdispersion:** Variance > Mean. Use [[30_Knowledge/Stats/03_Regression_Analysis/Negative Binomial Regression\|Negative Binomial Regression]] instead.
> - **Excess zeros:** Too many zeros in data. Use [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]].
...
> A key property of Poisson is that **Mean = Variance** ($\lambda$). If Variance > Mean, data is **overdispersed** (use [[30_Knowledge/Stats/03_Regression_Analysis/Negative Binomial Regression\|Negative Binomial Regression]]). If Variance < Mean, data is **underdispersed**.
...
> 2.  **Zero-Inflation:** If you have many more zeros than predicted (e.g., store is closed), use [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Poisson (ZIP)]].
...
|--------------|--------------|
| [[30_Knowledge/Stats/01_Foundations/Binomial Distribution\|Binomial Distribution]] | Poisson is limit as $n \to \infty$, $p \to 0$, $np = \lambda$ |
| [[30_Knowledge/Stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] | Time *between* Poisson events follows Exponential |
| [[30_Knowledge/Stats/01_Foundations/Gamma Distribution\|Gamma Distribution]] | Time for $k$ Poisson events follows Gamma |
| [[30_Knowledge/Stats/01_Foundations/Normal Distribution\|Normal Distribution]] | Poisson approaches Normal for large $\lambda$ |
...
### Directly Related
- [[30_Knowledge/Stats/03_Regression_Analysis/Poisson Regression\|Poisson Regression]] - Predicting counts with covariates
- [[30_Knowledge/Stats/01_Foundations/Exponential Distribution\|Exponential Distribution]] - Time between Poisson events
...
- [[30_Knowledge/Stats/01_Foundations/Binomial Distribution\|Binomial Distribution]] - Poisson is limit as $n \to \infty$, $p \to 0$

### Applications
- [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]] - Handling excess zeros
- [[30_Knowledge/Stats/01_Foundations/Hurdle Models\|Hurdle Models]] - Two-part count models
- [[30_Knowledge/Stats/01_Foundations/Overdispersion\|Overdispersion]] - When Poisson assumptions fail
