---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/exponential-distribution/","tags":["probability","foundations"]}
---
...
> - **Aging effects:** Components wear out over time. Use [[30_Knowledge/Stats/01_Foundations/Weibull Distribution\|Weibull Distribution]] instead.
...
> - **Time to nth event:** Use [[30_Knowledge/Stats/01_Foundations/Gamma Distribution\|Gamma Distribution]] for waiting time until $n$ events.
> - **Discrete waiting:** Counting trials until success. Use [[30_Knowledge/Stats/01_Foundations/Geometric Distribution\|Geometric Distribution]].
...
> [!warning] Pitfalls
> 1.  **The "Real World Ages" Problem:** Exponential implies components *never wear out*. A brand new bulb has the same failure probability as one that has run for 10 years. For mechanical wear, use [[30_Knowledge/Stats/01_Foundations/Weibull Distribution\|Weibull Distribution]].
...
### Directly Related
- [[30_Knowledge/Stats/01_Foundations/Poisson Distribution\|Poisson Distribution]] - Number of events in fixed time
- [[30_Knowledge/Stats/01_Foundations/Geometric Distribution\|Geometric Distribution]] - Discrete memoryless distribution
- [[30_Knowledge/Stats/01_Foundations/Weibull Distribution\|Weibull Distribution]] - Generalizes exponential; allows aging
- [[30_Knowledge/Stats/01_Foundations/Gamma Distribution\|Gamma Distribution]] - Time until $n$th event

### Applications
- [[30_Knowledge/Stats/07_Causal_Inference/Survival Analysis\|Survival Analysis]] - Time-to-event modeling
- [[30_Knowledge/Stats/02_Statistical_Inference/Hazard Ratio\|Hazard Ratio]] - Constant hazard in exponential
- [[30_Knowledge/Stats/02_Statistical_Inference/Kaplan-Meier Curves\|Kaplan-Meier Curves]] - Non-parametric survival
