---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/categorical-distribution/","tags":["probability","foundations"]}
---

## Definition

> [!abstract] Core Statement
> The **Categorical Distribution** models a ==single trial with K possible outcomes==, each with probability $p_k$. It is the generalization of [[30_Knowledge/Stats/01_Foundations/Bernoulli Distribution\|Bernoulli Distribution]] to more than 2 categories.
...
4. **Bayesian inference:** With [[30_Knowledge/Stats/01_Foundations/Dirichlet Distribution\|Dirichlet Distribution]] as prior
...
> - **Only 2 outcomes:** Use [[30_Knowledge/Stats/01_Foundations/Bernoulli Distribution\|Bernoulli Distribution]] (simpler)
> - **Multiple trials:** Use [[30_Knowledge/Stats/01_Foundations/Multinomial Distribution\|Multinomial Distribution]]
...
|--------------|--------------|
| [[30_Knowledge/Stats/01_Foundations/Bernoulli Distribution\|Bernoulli Distribution]] | Categorical with K=2 |
| [[30_Knowledge/Stats/01_Foundations/Multinomial Distribution\|Multinomial Distribution]] | n independent Categorical trials |
| [[30_Knowledge/Stats/01_Foundations/Dirichlet Distribution\|Dirichlet Distribution]] | Conjugate prior for probability vector $\mathbf{p}$ |
...
> 2. **Single trial:** For multiple trials, use [[30_Knowledge/Stats/01_Foundations/Multinomial Distribution\|Multinomial Distribution]].
...
### Directly Related
- [[30_Knowledge/Stats/01_Foundations/Bernoulli Distribution\|Bernoulli Distribution]] - Special case (K=2)
- [[30_Knowledge/Stats/01_Foundations/Multinomial Distribution\|Multinomial Distribution]] - Multiple Categorical trials
- [[30_Knowledge/Stats/01_Foundations/Dirichlet Distribution\|Dirichlet Distribution]] - Conjugate prior for $\mathbf{p}$

### Applications
- [[30_Knowledge/Stats/04_Supervised_Learning/Naive Bayes\|Naive Bayes]] - Feature likelihoods
- [[30_Knowledge/Stats/03_Regression_Analysis/Logistic Regression\|Logistic Regression]] - Multiclass extension
- Softmax Function - Converts logits to categorical probabilities
