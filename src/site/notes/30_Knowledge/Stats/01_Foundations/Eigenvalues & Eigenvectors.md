---
{"dg-publish":true,"permalink":"/30-knowledge/stats/01-foundations/eigenvalues-and-eigenvectors/","tags":["probability","foundations"]}
---
...
- [[30_Knowledge/Stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] - Main application in stats.
- [[30_Knowledge/Stats/01_Foundations/Matrix Multiplication\|Matrix Multiplication]] - The operation $Av$.
- [[30_Knowledge/Stats/01_Foundations/Covariance Matrix\|Covariance Matrix]] - The input matrix often used.
- [[30_Knowledge/Stats/01_Foundations/Singular Value Decomposition (SVD)\|Singular Value Decomposition (SVD)]] - Generalization for non-square matrices (used in calculating PCA in practice).
- [[30_Knowledge/Stats/01_Foundations/Positive Definite Matrices\|Positive Definite Matrices]] - PD matrices have all positive eigenvalues.
- [[30_Knowledge/Stats/01_Foundations/Linear Transformations\|Linear Transformations]] - Eigenvectors are preserved directions.
- [[30_Knowledge/Stats/01_Foundations/Determinants & Matrix Inversion\|Determinants & Matrix Inversion]] - Det(A) = product of eigenvalues.

---

## When to Use

> [!success] Use Eigenvalues & Eigenvectors When...
