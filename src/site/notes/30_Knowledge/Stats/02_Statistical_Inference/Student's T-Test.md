---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/student-s-t-test/","tags":["inference","hypothesis-testing"]}
---
...
> - Group **variances are equal** ([[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]] $p > 0.05$).

> [!failure] Use Alternatives When...
> - Variances are **unequal**: Use [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]].
> - Data is **not normal** and $n$ is small: Use [[30_Knowledge/Stats/02_Statistical_Inference/Mann-Whitney U Test\|Mann-Whitney U Test]].
> - **Three or more groups**: Use [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]].
...
- [ ] **Normality:** Data in each group is approximately normally distributed. (Check: [[30_Knowledge/Stats/02_Statistical_Inference/Shapiro-Wilk Test\|Shapiro-Wilk Test]], [[30_Knowledge/Stats/09_EDA_and_Visualization/Q-Q Plot\|Q-Q Plot]]). Robust if $n > 30$.
- [ ] ==**Homogeneity of Variance:**== Variances are equal across groups. (Check: [[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]]). If violated, use [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]].
...
> 3.  **Effect Size:** A significant p-value does not mean a *large* difference. Always report [[30_Knowledge/Stats/02_Statistical_Inference/Effect Size Measures\|Effect Size Measures]] (Cohen's d).
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]] - Robust to unequal variances.
- [[30_Knowledge/Stats/02_Statistical_Inference/Mann-Whitney U Test\|Mann-Whitney U Test]] - Non-parametric alternative.
- [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] - For 3+ groups.
- [[30_Knowledge/Stats/02_Statistical_Inference/Effect Size Measures\|Effect Size Measures]] - Cohen's d.
- [[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]] - Variance equality check.
