---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/mann-whitney-u-test/","tags":["inference","hypothesis-testing"]}
---
...
> The **Mann-Whitney U Test** is a non-parametric test that compares whether two independent groups come from the same distribution. It is the **non-parametric alternative** to the [[30_Knowledge/Stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] when normality cannot be assumed.
...
> - Data is **paired/dependent** — use [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]].
> - You have **more than 2 groups** — use [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]].
...
> - *Solution:* Use [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] for paired data.
>
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] — When normality holds

**Extensions:**
- [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] — Paired version
- [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] — More than 2 groups

**Effect Size:**
- [[30_Knowledge/Stats/02_Statistical_Inference/Effect Size Measures\|Effect Size]] — Why p-value isn't enough
