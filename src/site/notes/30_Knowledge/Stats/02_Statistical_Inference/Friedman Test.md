---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/friedman-test/","tags":["inference","hypothesis-testing"]}
---
...
> The **Friedman Test** is a non-parametric alternative to [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] for comparing ==three or more related groups==. It uses ranks instead of raw values, making it robust to non-normality and outliers.
...
> - Groups are **independent** (use [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]]).
> - Only **2 related groups** (use [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]]).
> - Data is **normal** with equal variances (use [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] for more power).
...
> 
> **Correct Test:** Use [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] for independent groups.
> 
> **Rule:** 
...
**Prerequisites:**
- [[30_Knowledge/Stats/02_Statistical_Inference/Wilcoxon Signed-Rank Test\|Wilcoxon Signed-Rank Test]] - 2 related groups version
- [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] - Parametric alternative

**Comparisons:**
- [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Independent groups version
- [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] - Parametric for independent groups

**Post-Hoc Tests:**
- [[30_Knowledge/Stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]] - Parametric alternative
