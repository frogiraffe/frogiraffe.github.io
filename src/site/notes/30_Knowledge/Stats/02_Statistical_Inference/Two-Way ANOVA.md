---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/two-way-anova/","tags":["inference","hypothesis-testing"]}
---

## Definition

> [!abstract] Core Statement
> **Two-Way ANOVA** extends [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] to examine the effects of ==two independent categorical variables== (factors) on a continuous outcome. It can detect **main effects** of each factor and their **interaction effect**.
...
> - **More than 2 factors:** Use Multi-Way ANOVA or [[30_Knowledge/Stats/02_Statistical_Inference/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]].
> - **Non-normal data:** Use non-parametric alternatives (Aligned Rank Transform ANOVA).
> - **Repeated measures:** Use [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]].
...
- [ ] **Homogeneity of Variance:** Equal variances across all factor combinations (check with [[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]]).
...
> 3. **Multiple comparisons:** Post-hoc tests ([[30_Knowledge/Stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]]) are needed if main effects are significant.
...
- [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] - Single factor.
- [[30_Knowledge/Stats/02_Statistical_Inference/Mixed ANOVA (Between-Within)\|Mixed ANOVA (Between-Within)]] - Combines between and within factors.
- [[30_Knowledge/Stats/03_Regression_Analysis/Interaction Effects\|Interaction Effects]] - The key addition in Two-Way ANOVA.
- [[30_Knowledge/Stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]] - Post-hoc comparisons.
