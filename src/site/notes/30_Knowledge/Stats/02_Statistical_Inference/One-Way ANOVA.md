---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/one-way-anova/","tags":["inference","hypothesis-testing"]}
---
...
> - **Variances are approximately equal** across groups ([[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]]).

> [!failure] Alternatives
> - **Unequal variances:** [[30_Knowledge/Stats/02_Statistical_Inference/Welch's ANOVA\|Welch's ANOVA]].
> - **Non-normal data:** [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]].
> - **Two groups:** [[30_Knowledge/Stats/02_Statistical_Inference/Student's T-Test\|Student's T-Test]] or [[30_Knowledge/Stats/02_Statistical_Inference/Welch's T-Test\|Welch's T-Test]].
...
> A significant ANOVA result only indicates that ==at least one group differs==. To find *which* groups differ, you must run **Post-Hoc Tests** (e.g., [[30_Knowledge/Stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]]).
...
- [ ] **Normality:** Data within each group is normally distributed. (Check per-group: [[30_Knowledge/Stats/02_Statistical_Inference/Shapiro-Wilk Test\|Shapiro-Wilk Test]]).
- [ ] ==**Homogeneity of Variance:**== Variances are equal across groups. (Check: [[30_Knowledge/Stats/02_Statistical_Inference/Levene's Test\|Levene's Test]]). If violated, use [[30_Knowledge/Stats/02_Statistical_Inference/Welch's ANOVA\|Welch's ANOVA]].
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Welch's ANOVA\|Welch's ANOVA]] - Robust to unequal variances.
- [[30_Knowledge/Stats/02_Statistical_Inference/Tukey's HSD\|Tukey's HSD]] - Post-hoc pairwise comparisons.
- [[30_Knowledge/Stats/02_Statistical_Inference/Bonferroni Correction\|Bonferroni Correction]] - Alternative multiple comparison adjustment.
- [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Non-parametric alternative.
- [[30_Knowledge/Stats/02_Statistical_Inference/MANOVA\|MANOVA]] - Multiple dependent variables.
