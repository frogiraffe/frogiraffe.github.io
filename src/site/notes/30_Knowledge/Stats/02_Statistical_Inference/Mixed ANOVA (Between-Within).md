---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/mixed-anova-between-within/","tags":["inference","hypothesis-testing"]}
---
...
- [ ] **Complete data** (or use [[30_Knowledge/Stats/03_Regression_Analysis/Linear Mixed Models (LMM)\|Linear Mixed Models (LMM)]] for missing data).
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Two-Way ANOVA\|Two-Way ANOVA]] - Both factors between-subjects.
- [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] - Within-subjects only.
- [[30_Knowledge/Stats/03_Regression_Analysis/Linear Mixed Models (LMM)\|Linear Mixed Models (LMM)]] - More flexible alternative.
- [[30_Knowledge/Stats/03_Regression_Analysis/Interaction Effects\|Interaction Effects]]
