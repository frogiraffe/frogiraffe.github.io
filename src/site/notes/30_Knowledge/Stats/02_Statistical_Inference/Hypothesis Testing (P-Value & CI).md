---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/hypothesis-testing-p-value-and-ci/","tags":["inference","hypothesis-testing"]}
---
...
![P-value Visualization: Area in the tails of the distribution](https://commons.wikimedia.org/wiki/Special:FilePath/P-value_in_statistical_significance_testing.svg)
...
> 2.  **Statistical Significance $\neq$ Practical Significance.** A p-value of 0.001 for a tiny effect (e.g., 0.001 kg weight loss) is meaningless. Always report [[30_Knowledge/Stats/02_Statistical_Inference/Effect Size Measures\|Effect Size Measures]].
> 3.  **Multiple Comparisons Problem:** Running 20 tests at $\alpha = 0.05$ guarantees roughly 1 false positive by chance. Use [[30_Knowledge/Stats/02_Statistical_Inference/Bonferroni Correction\|Bonferroni Correction]] or FDR.
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]]
...
- [[30_Knowledge/Stats/01_Foundations/Bayesian Statistics\|Bayesian Statistics]] - An alternative framework.
