---
{"dg-publish":true,"permalink":"/30-knowledge/stats/02-statistical-inference/tukey-s-hsd/","tags":["inference","hypothesis-testing"]}
---

## Definition

> [!abstract] Core Statement
> **Tukey's HSD (Honestly Significant Difference)** is a **post-hoc test** used after a significant [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]] to determine ==which specific group pairs are significantly different==. It controls the **Family-Wise Error Rate (FWER)**, preventing inflation of Type I error from multiple comparisons.
...
> - If you have **specific hypotheses** (not all pairs): Use planned contrasts or [[30_Knowledge/Stats/02_Statistical_Inference/Bonferroni Correction\|Bonferroni Correction]].
> - If ANOVA assumptions are violated: Use [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] followed by Dunn's test.
...
Inherits assumptions from [[30_Knowledge/Stats/02_Statistical_Inference/One-Way ANOVA\|One-Way ANOVA]]:
- [ ] Independence.
- [ ] Normality.
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Bonferroni Correction\|Bonferroni Correction]] - More conservative alternative.
- [[30_Knowledge/Stats/02_Statistical_Inference/Kruskal-Wallis Test\|Kruskal-Wallis Test]] - Non-parametric ANOVA.
