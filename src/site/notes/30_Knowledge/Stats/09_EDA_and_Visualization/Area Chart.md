---
{"dg-publish":true,"permalink":"/30-knowledge/stats/09-eda-and-visualization/area-chart/","tags":["eda","visualization"]}
---
...
> Never use a **Simple Area Chart** with multiple overlapping series that are NOT stacked. The colors will blend and the data underneath will be obscured, making it impossible to read. Use [[30_Knowledge/Stats/09_EDA_and_Visualization/Line Chart\|Line Chart]] or **Stacked Area Chart** instead.

---

## Related Concepts

- [[30_Knowledge/Stats/09_EDA_and_Visualization/Line Chart\|Line Chart]] - The trend-focused ancestor.
- [[30_Knowledge/Stats/09_EDA_and_Visualization/Bar Chart\|Bar Chart]] - Specifically the Stacked Bar Chart for discrete intervals.

---

## When to Use

> [!success] Use Area Chart When...
