---
{"dg-publish":true,"permalink":"/30-knowledge/stats/09-eda-and-visualization/line-chart/","tags":["eda","visualization"]}
---
...
> - The X-axis is categorical with no inherent order (use a [[30_Knowledge/Stats/09_EDA_and_Visualization/Bar Chart\|Bar Chart]]).
...
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Testing if a line chart's properties change over time.
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Auto-Correlation (ACF & PACF)\|Auto-Correlation (ACF & PACF)]] - Analyzing patterns in time series lines.
- [[30_Knowledge/Stats/09_EDA_and_Visualization/Scatter Plot\|Scatter Plot]] - When there is no inherent ordering between points.
