---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/multiple-linear-regression/","tags":["regression","modeling"]}
---
...
All assumptions from [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]] apply, plus one critical addition:

- [ ] **Linearity**
- [ ] **Independence**
- [ ] **Normality of Residuals**
- [ ] **Equality of Variance (Homoscedasticity)**
- [ ] **No Multicollinearity:** Predictors ($X$s) should not be highly correlated with each other. (Check: [[30_Knowledge/Stats/03_Regression_Analysis/VIF (Variance Inflation Factor)\|VIF (Variance Inflation Factor)]]).
...
> 2.  **Overfitting:** Adding too many predictors can make the model fit noise rather than signal. Use [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] or [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]] for regularization.
...
- [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]] - The single-predictor case.
- [[30_Knowledge/Stats/03_Regression_Analysis/VIF (Variance Inflation Factor)\|VIF (Variance Inflation Factor)]] - Multicollinearity diagnostic.
- [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] - Regularization to handle multicollinearity.
- [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]] - Feature selection via L1 penalty.
