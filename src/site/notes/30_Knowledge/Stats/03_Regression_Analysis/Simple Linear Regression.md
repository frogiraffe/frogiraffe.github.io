---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/simple-linear-regression/","tags":["regression","modeling"]}
---
...
> - You have multiple predictors (use [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]]).
> - The outcome is categorical (use [[30_Knowledge/Stats/03_Regression_Analysis/Logistic Regression\|Logistic Regression]]).
...
> - [ ] **I**ndependence: Observations are independent. (Check: [[30_Knowledge/Stats/08_Time_Series_Analysis/Durbin-Watson Test\|Durbin-Watson Test]] for time series).
> - [ ] **N**ormality: ==Residuals== (not $Y$!) are normally distributed. (Check: [[30_Knowledge/Stats/09_EDA_and_Visualization/Q-Q Plot\|Q-Q Plot]], [[30_Knowledge/Stats/02_Statistical_Inference/Shapiro-Wilk Test\|Shapiro-Wilk Test]]).
> - [ ] **E**qual Variance (Homoscedasticity): The variance of residuals is constant across all $X$. (Check: [[30_Knowledge/Stats/03_Regression_Analysis/Breusch-Pagan Test\|Breusch-Pagan Test]], Residual vs Fitted plot).
...
> 2.  **Sensitive to Outliers:** Extreme points can disproportionately influence the slope and $R^2$. Check [[30_Knowledge/Stats/03_Regression_Analysis/Cook's Distance\|Cook's Distance]].
...
- [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]] - More than one predictor.
- [[30_Knowledge/Stats/02_Statistical_Inference/Pearson Correlation\|Pearson Correlation]] - Related but different (Correlation $\neq$ Slope).
- [[30_Knowledge/Stats/03_Regression_Analysis/Residual Analysis\|Residual Analysis]] - Checking assumptions.
- [[30_Knowledge/Stats/03_Regression_Analysis/Cook's Distance\|Cook's Distance]] - Identifying influential observations.
