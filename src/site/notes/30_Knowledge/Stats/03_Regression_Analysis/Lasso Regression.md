---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/lasso-regression/","tags":["regression","modeling"]}
---
...
**Key Feature:** Unlike [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] (L2), Lasso produces **sparse** models — many coefficients become exactly zero.
...
>   - *Use:* [[30_Knowledge/Stats/01_Foundations/Elastic Net\|Elastic Net]] (combines L1 + L2) instead.
> - You need **all predictors** in the model for theoretical reasons.
> - Prediction is more important than feature selection — [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] often predicts slightly better.
...
**Prerequisites:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]]
- [[30_Knowledge/Stats/03_Regression_Analysis/Regularization\|Regularization]]
- [[30_Knowledge/Stats/01_Foundations/Bias-Variance Trade-off\|Bias-Variance Trade-off]]

**Alternatives:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] — L2 penalty, no zeros
- [[30_Knowledge/Stats/01_Foundations/Elastic Net\|Elastic Net]] — Combines L1 + L2

**Extensions:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Group Lasso\|Group Lasso]] — Select entire groups of variables
- [[30_Knowledge/Stats/03_Regression_Analysis/Adaptive Lasso\|Adaptive Lasso]] — Weights penalties by initial estimates
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] — Required for tuning λ
