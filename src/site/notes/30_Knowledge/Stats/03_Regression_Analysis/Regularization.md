---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/regularization/","tags":["regression","modeling"]}
---
...
|--------|---------|--------|-------|
| **[[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]]** | L2 ($\sum \beta^2$) | Shrinks all coeffs; none to zero. | Multicollinearity, Dense data. |
| **[[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]]** | L1 ($\sum |\beta|$) | Shrinks some to **exactly zero**. | Feature Selection, Sparse data. |
| **[[30_Knowledge/Stats/01_Foundations/Elastic Net\|Elastic Net]]** | L1 + L2 | Best of both worlds. | Correlated features, Feature selection. |
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] - Essential for choosing $\lambda$ (strength of penalty).
...
# Example implementation of Regularization
