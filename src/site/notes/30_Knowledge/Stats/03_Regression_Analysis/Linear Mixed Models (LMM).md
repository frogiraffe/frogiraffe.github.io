---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/linear-mixed-models-lmm/","tags":["regression","modeling"]}
---
...
> - [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] assumptions (sphericity) are violated.
...
> - Outcome is **non-normal** (use [[30_Knowledge/Stats/03_Regression_Analysis/Generalized Linear Models (GLM)\|Generalized Linear Models (GLM)]] with random effects: GLMM).
...
**Prerequisites:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Multiple Linear Regression\|Multiple Linear Regression]] - Fixed effects only
- [[30_Knowledge/Stats/02_Statistical_Inference/Repeated Measures ANOVA\|Repeated Measures ANOVA]] - Simpler repeated measures

**Extensions:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Generalized Linear Models (GLM)\|Generalized Linear Models (GLM)]] - For non-normal outcomes (GLMM)
- [[30_Knowledge/Stats/01_Foundations/Bayesian Statistics\|Bayesian Statistics]] - Bayesian multilevel models

**Applications:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Panel Data Analysis\|Panel Data Analysis]] - Econometric perspective
- [[30_Knowledge/Stats/03_Regression_Analysis/Growth Curve Models\|Growth Curve Models]] - Longitudinal trajectories
