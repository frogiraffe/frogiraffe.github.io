---
{"dg-publish":true,"permalink":"/30-knowledge/stats/03-regression-analysis/negative-binomial-regression/","tags":["regression","modeling"]}
---

## Definition

> [!abstract] Core Statement
> **Negative Binomial Regression** is an extension of [[30_Knowledge/Stats/03_Regression_Analysis/Poisson Regression\|Poisson Regression]] used when count data exhibits ==overdispersion== (Variance > Mean). It introduces an extra parameter to model the heterogeneity in event rates across observations.
...
> - Outcome is a **count**.
> - The [[30_Knowledge/Stats/03_Regression_Analysis/Poisson Regression\|Poisson Regression]] model shows **overdispersion** (Dispersion statistic > 1.5).
...
> - Excess zeros are the main problem (use [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]]).
...
> [!warning] Pitfalls
> 1.  **Still sensitive to excess zeros.** If you have structural zeros (e.g., people who will *never* use a product), consider [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]].
...
- [[30_Knowledge/Stats/03_Regression_Analysis/Poisson Regression\|Poisson Regression]] - The baseline count model.
- [[30_Knowledge/Stats/03_Regression_Analysis/Zero-Inflated Models\|Zero-Inflated Models]] - For excess zeros.
...
- **Book:** Hilbe, J. M. (2011). *Negative Binomial Regression* (2nd ed.). Cambridge University Press. [Cambridge Link](https://www.cambridge.org/de/universitypress/subjects/statistics-and-probability/econometrics-and-mathematical-methods/negative-binomial-regression-2nd-edition)
