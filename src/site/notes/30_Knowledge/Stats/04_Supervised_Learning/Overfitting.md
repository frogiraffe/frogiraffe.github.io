---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/overfitting/","tags":["supervised_learning"]}
---
...
> **Overfitting** occurs when a model learns the **noise** in training data rather than the underlying **signal**. **Underfitting** occurs when a model is **too simple** to capture the underlying pattern.
...
### 2. Regularization
- [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] — L2 penalty shrinks coefficients
- [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]] — L1 penalty zeros out features
...
### 5. Ensemble Methods
- [[30_Knowledge/Stats/04_Supervised_Learning/Random Forest\|Random Forest]] — Averaging reduces variance
- [[30_Knowledge/Stats/04_Supervised_Learning/Gradient Boosting\|Gradient Boosting]] with regularization
...
**Solutions:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Regularization\|Regularization]] — L1/L2 penalties
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] — Proper evaluation
- [[30_Knowledge/Stats/04_Supervised_Learning/Ensemble Methods\|Ensemble Methods]] — Variance reduction

**Diagnostics:**
- [[30_Knowledge/Stats/01_Foundations/Bias-Variance Trade-off\|Bias-Variance Trade-off]] — Theoretical framework
- [[30_Knowledge/Stats/04_Supervised_Learning/Learning Curves\|Learning Curves]] — Visual diagnosis tool

---

## When to Use

> [!success] Use Overfitting When...
