---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/bootstrap-methods/","tags":["machine-learning","supervised"]}
---

## Definition

> [!abstract] Core Statement
> **Bootstrap** is a ==resampling method== that estimates the sampling distribution of a statistic by repeatedly resampling (with replacement) from the observed data. It allows estimation of [[30_Knowledge/Stats/02_Statistical_Inference/Confidence Intervals\|Confidence Intervals]], [[30_Knowledge/Stats/01_Foundations/Standard Error\|Standard Error]], and hypothesis testing **without parametric assumptions**.
...
- [[30_Knowledge/Stats/02_Statistical_Inference/Permutation Tests\|Permutation Tests]] - Resampling for hypothesis testing.
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] - Resampling for model validation.
- [[30_Knowledge/Stats/01_Foundations/Jackknife\|Jackknife]] - Alternative resampling method (leave-one-out).
