---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/overfitting-and-underfitting/","tags":["machine-learning","supervised"]}
---
...
> - **High variance** in [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] folds.
...
| Method | Mechanism |
|--------|-----------|
| **[[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]]** | Evaluate on multiple test folds; detects overfitting. |
| **Regularization** ([[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]], [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]]) | Penalize large coefficients; reduce model complexity. |
...
> [!warning] Pitfalls
> 1. **Cannot truly eliminate both.** [[30_Knowledge/Stats/01_Foundations/Bias-Variance Trade-off\|Bias-Variance Trade-off]] is fundamental.
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] - Detection method.
- [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] / [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]] - Prevention via regularization.
