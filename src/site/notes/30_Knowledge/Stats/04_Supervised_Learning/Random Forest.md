---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/random-forest/","tags":["machine-learning","supervised"]}
---

## Definition

> [!abstract] Core Statement
> **Random Forest** is an ensemble learning method that operates by constructing a multitude of **[[30_Knowledge/Stats/04_Supervised_Learning/Decision Tree\|Decision Tree]]s** at training time. For classification, it outputs the **mode** (majority vote) of the classes; for regression, it is the **mean** prediction.
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Decision Tree\|Decision Tree]] - The building block.
- [[30_Knowledge/Stats/04_Supervised_Learning/Gradient Boosting\|Gradient Boosting]] - The sequential alternative (often slightly more accurate but harder to tune).
- [[30_Knowledge/Stats/04_Supervised_Learning/Bootstrap Methods\|Bootstrap Methods]] - The sampling technique used.
- [[30_Knowledge/Stats/04_Supervised_Learning/Ensemble Methods\|Ensemble Methods]]

---

## When to Use

> [!success] Use Random Forest When...
