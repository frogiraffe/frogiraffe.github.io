---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/decision-tree/","tags":["machine-learning","supervised"]}
---
...
![Decision Tree Model Visualization](https://upload.wikimedia.org/wikipedia/commons/f/ff/Decision_tree_model.png)
...
3.  **Foundation:** The building block for powerful ensembles like [[30_Knowledge/Stats/04_Supervised_Learning/Random Forest\|Random Forest]] and [[30_Knowledge/Stats/04_Supervised_Learning/Gradient Boosting\|Gradient Boosting]].
...
> 2.  **Instability:** A small change in data can result in a completely different tree. (Solved by [[30_Knowledge/Stats/04_Supervised_Learning/Random Forest\|Random Forest]]).
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Random Forest\|Random Forest]] - Many trees (Bagging).
- [[30_Knowledge/Stats/04_Supervised_Learning/Gradient Boosting\|Gradient Boosting]]
 - Sequential trees (Boosting).
- [[30_Knowledge/Stats/04_Supervised_Learning/Overfitting\|Overfitting]] - The main weakness.

---

## When to Use

> [!success] Use Decision Tree When...
