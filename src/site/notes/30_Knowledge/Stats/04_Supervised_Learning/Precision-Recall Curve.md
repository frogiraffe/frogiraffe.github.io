---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/precision-recall-curve/","tags":["machine-learning","supervised"]}
---
...
> - Comparing models where [[30_Knowledge/Stats/04_Supervised_Learning/ROC-AUC\|ROC-AUC]] gives **misleadingly optimistic** results.
...
**Prerequisites:**
- [[30_Knowledge/Stats/04_Supervised_Learning/Confusion Matrix\|Confusion Matrix]] — TP, FP, FN definitions
- [[30_Knowledge/Stats/03_Regression_Analysis/Binary Logistic Regression\|Binary Logistic Regression]] — Common classifier to evaluate

**Companions:**
- [[30_Knowledge/Stats/04_Supervised_Learning/ROC-AUC\|ROC-AUC]] — Alternative for balanced data
- [[30_Knowledge/Stats/04_Supervised_Learning/F1 Score\|F1 Score]] — Harmonic mean of Precision and Recall

**Applications:**
- [[30_Knowledge/Stats/04_Supervised_Learning/Imbalanced Data\|Imbalanced Data]] — When PR curve is essential
- [[30_Knowledge/Stats/04_Supervised_Learning/Threshold Optimization\|Threshold Optimization]] — Choosing operating point on curve
