---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/curse-of-dimensionality/","tags":["machine-learning","supervised"]}
---
...
| **K-Means** | All points equidistant | [[30_Knowledge/Stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] |
| **Density Estimation** | No reliable density | More data, feature selection |
| **Linear Regression** | More features than samples | [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]], [[30_Knowledge/Stats/03_Regression_Analysis/Ridge Regression\|Ridge Regression]] |
...
- **[[30_Knowledge/Stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]]** — Linear projection
- **t-SNE & UMAP** — Nonlinear embedding
- **Autoencoders** — Neural network approach

### 2. Feature Selection
- Remove irrelevant/redundant features
- Use [[30_Knowledge/Stats/04_Supervised_Learning/Feature Importance\|Feature Importance]] to identify key variables
...
- [[30_Knowledge/Stats/05_Unsupervised_Learning/PCA (Principal Component Analysis)\|PCA (Principal Component Analysis)]] — Dimension reduction
- [[30_Knowledge/Stats/01_Foundations/Feature Scaling\|Feature Scaling]] — Prerequisite for many methods
- [[30_Knowledge/Stats/03_Regression_Analysis/Lasso Regression\|Lasso Regression]] — Automatic feature selection
- [[30_Knowledge/Stats/04_Supervised_Learning/Overfitting\|Overfitting]] — Related problem in high dimensions

---

## When to Use

> [!success] Use Curse of Dimensionality When...
...
# Example implementation of Curse of Dimensionality
