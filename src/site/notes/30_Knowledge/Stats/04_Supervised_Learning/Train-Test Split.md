---
{"dg-publish":true,"permalink":"/30-knowledge/stats/04-supervised-learning/train-test-split/","tags":["machine-learning","supervised"]}
---

## Definition

> [!abstract] Core Statement
> **Train-Test Split** is a fundamental technique in machine learning where data is divided into two subsets: a ==training set== (to fit the model) and a ==test set== (to evaluate performance). This prevents [[30_Knowledge/Stats/04_Supervised_Learning/Overfitting & Underfitting\|overfitting]] by assessing generalization to unseen data.
...
> - **Small datasets:** Use [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] instead (more efficient use of data).
...
> 4. **Small Data:** Single split has high variance. Use [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]].
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Cross-Validation\|Cross-Validation]] - More robust alternative for small data.
...
- [[30_Knowledge/Stats/04_Supervised_Learning/Model Evaluation Metrics\|Model Evaluation Metrics]]
