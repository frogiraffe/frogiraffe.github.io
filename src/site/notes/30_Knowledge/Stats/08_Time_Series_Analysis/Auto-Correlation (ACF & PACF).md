---
{"dg-publish":true,"permalink":"/30-knowledge/stats/08-time-series-analysis/auto-correlation-acf-and-pacf/","tags":["time-series"]}
---
...
These are the primary tools for identifying the order (p, q) of [[30_Knowledge/Stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]].
...
- [[30_Knowledge/Stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]] - The model built using these tools.
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Prerequisite.
- [[30_Knowledge/Stats/02_Statistical_Inference/Ljung-Box Test\|Ljung-Box Test]] - Statistical test for "White Noise" (checking group of lags).

---

## When to Use

> [!success] Use Auto-Correlation (ACF & PACF) When...
