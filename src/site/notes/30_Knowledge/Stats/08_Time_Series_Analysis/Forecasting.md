---
{"dg-publish":true,"permalink":"/30-knowledge/stats/08-time-series-analysis/forecasting/","tags":["time-series"]}
---
...
> **Forecasting** is the process of making predictions about future values based on historical data. Modern approaches combine classical statistical methods ([[30_Knowledge/Stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA]], [[30_Knowledge/Stats/08_Time_Series_Analysis/Smoothing\|Exponential Smoothing]]) with ==machine learning== (XGBoost, Neural Networks, Prophet).
...
**Prerequisites:**
- [[30_Knowledge/Stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]] — Classical statistical approach
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] — Key assumption
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Auto-Correlation (ACF & PACF)\|Auto-Correlation (ACF & PACF)]] — Pattern identification

**Extensions:**
- [[30_Knowledge/Stats/08_Time_Series_Analysis/GARCH Models\|GARCH Models]] — Volatility forecasting
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Vector Autoregression (VAR)\|Vector Autoregression (VAR)]] — Multivariate

---

## When to Use

> [!success] Use Forecasting When...
