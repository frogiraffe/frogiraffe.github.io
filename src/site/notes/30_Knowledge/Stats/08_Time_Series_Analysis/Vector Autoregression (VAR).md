---
{"dg-publish":true,"permalink":"/30-knowledge/stats/08-time-series-analysis/vector-autoregression-var/","tags":["time-series"]}
---
...
- [[30_Knowledge/Stats/08_Time_Series_Analysis/ARIMA Models\|ARIMA Models]] - Univariate case.
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Granger Causality\|Granger Causality]] - Causality test within VAR.
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|Stationarity (ADF & KPSS)]] - Requirement.
...
> **Vector Autoregression (VAR)** ... Refer to standard documentation
...
> [!success] Use Vector Autoregression (VAR) When...
> - Refer to standard documentation
> - Refer to standard documentation
...
# Example implementation of Vector Autoregression (VAR)
...
```r
# Vector Autoregression (VAR) in R
set.seed(42)
