---
{"dg-publish":true,"permalink":"/30-knowledge/stats/08-time-series-analysis/durbin-watson-test/","tags":["time-series"]}
---

## Definition

> [!abstract] Core Statement
> The **Durbin-Watson (DW) Test** detects **autocorrelation** (or serial correlation) in the residuals of a regression analysis. It tests whether adjacent residuals are correlated, which violates the assumption of independence in [[30_Knowledge/Stats/03_Regression_Analysis/Simple Linear Regression\|Simple Linear Regression]].
...
> - Use [[30_Knowledge/Stats/08_Time_Series_Analysis/Breusch-Godfrey Test\|Breusch-Godfrey Test]] for higher-order autocorrelation (lag > 1).
...
- [ ] **No Lagged DV:** Independent variables cannot include lagged response variables ($Y_{t-1}$). Use [[30_Knowledge/Stats/08_Time_Series_Analysis/Breusch-Godfrey Test\|Breusch-Godfrey Test]] instead.
...
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Breusch-Godfrey Test\|Breusch-Godfrey Test]] - More general test for AR(p) errors.
- [[30_Knowledge/Stats/02_Statistical_Inference/Ljung-Box Test\|Ljung-Box Test]] - Tests white noise in ARIMA residuals.
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Time Series Analysis\|Time Series Analysis]]
