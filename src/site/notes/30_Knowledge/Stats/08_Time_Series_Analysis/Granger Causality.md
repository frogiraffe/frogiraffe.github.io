---
{"dg-publish":true,"permalink":"/30-knowledge/stats/08-time-series-analysis/granger-causality/","tags":["time-series"]}
---
...
1. **Stationarity:** Both series must be stationary (use [[30_Knowledge/Stats/08_Time_Series_Analysis/Stationarity (ADF & KPSS)\|ADF test]])
...
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Auto-Correlation (ACF & PACF)\|Auto-Correlation (ACF & PACF)]] — Understanding temporal structure
- [[30_Knowledge/Stats/08_Time_Series_Analysis/Vector Autoregression (VAR)\|Vector Autoregression (VAR)]] — Multivariate framework
...
**Alternatives:**
- [[30_Knowledge/Stats/07_Causal_Inference/Causal Inference\|Causal Inference]] — For true causal identification
- [[30_Knowledge/Stats/07_Causal_Inference/Instrumental Variables (IV)\|Instrumental Variables (IV)]] — When you need causality, not just prediction
