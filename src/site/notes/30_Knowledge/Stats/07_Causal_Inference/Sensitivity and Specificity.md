---
{"dg-publish":true,"permalink":"/30-knowledge/stats/07-causal-inference/sensitivity-and-specificity/","tags":["causal-inference"]}
---
...
> [!failure] Limitations...
> - They describe **one threshold**. For overall performance, use [[30_Knowledge/Stats/04_Supervised_Learning/ROC-AUC\|ROC-AUC]].
...
The [[30_Knowledge/Stats/04_Supervised_Learning/ROC-AUC\|ROC-AUC]] curve visualizes this trade-off across all thresholds.

### Relationship to Bayes' Theorem

Using [[30_Knowledge/Stats/01_Foundations/Bayes' Theorem\|Bayes' Theorem]], we can convert sensitivity/specificity to predictive values:
...
**Metrics:**
- [[30_Knowledge/Stats/04_Supervised_Learning/ROC-AUC\|ROC-AUC]] - Aggregate performance across thresholds
- [[30_Knowledge/Stats/04_Supervised_Learning/Confusion Matrix\|Confusion Matrix]] - Full breakdown of predictions
- [[30_Knowledge/Stats/04_Supervised_Learning/Precision-Recall Curve\|Precision-Recall Curve]] - Alternative for imbalanced data

**Theory:**
- [[30_Knowledge/Stats/01_Foundations/Bayes' Theorem\|Bayes' Theorem]] - Converting between conditional probabilities
- [[30_Knowledge/Stats/02_Statistical_Inference/Type I & Type II Errors\|Type I & Type II Errors]] - Error framework

**Applications:**
- [[30_Knowledge/Stats/03_Regression_Analysis/Binary Logistic Regression\|Binary Logistic Regression]] - Probability-based classification
