---
{"dg-publish":true,"permalink":"/30-knowledge/stats/07-causal-inference/causal-inference/","tags":["causal-inference"]}
---
...
|--------|-------------|----------------|
| [[30_Knowledge/Stats/07_Causal_Inference/Propensity Score Matching (PSM)\|Propensity Score Matching (PSM)]] | Observational data, rich covariates | No unmeasured confounders |
| [[30_Knowledge/Stats/07_Causal_Inference/Difference-in-Differences\|Difference-in-Differences]] | Panel data, policy change | Parallel pre-trends |
| [[30_Knowledge/Stats/07_Causal_Inference/Instrumental Variables (IV)\|Instrumental Variables (IV)]] | Have exogenous instrument | Exclusion restriction |
| [[30_Knowledge/Stats/07_Causal_Inference/Regression Discontinuity Design (RDD)\|Regression Discontinuity Design (RDD)]] | Assignment by threshold | Continuity at cutoff |
| [[30_Knowledge/Stats/07_Causal_Inference/Synthetic Control Method\|Synthetic Control Method]] | One treated unit, multiple controls | Pre-treatment fit |
...
**Prerequisites:**
- [[30_Knowledge/Stats/01_Foundations/Confounding Variables\|Confounding Variables]] — Why naive comparisons fail
- [[30_Knowledge/Stats/01_Foundations/Correlation vs Causation\|Correlation vs Causation]] — The core distinction
- [[30_Knowledge/Stats/10_Ethics_and_Biases/Simpson's Paradox\|Simpson's Paradox]] — When aggregation reverses effects
...
**Advanced:**
- [[30_Knowledge/Stats/07_Causal_Inference/DAGs (Directed Acyclic Graphs)\|DAGs (Directed Acyclic Graphs)]] — Visual causal reasoning
- [[30_Knowledge/Stats/01_Foundations/Structural Equation Modeling (SEM)\|Structural Equation Modeling (SEM)]] — Formal causal models
- [[30_Knowledge/Stats/07_Causal_Inference/Judea Pearl's Causal Hierarchy\|Judea Pearl's Causal Hierarchy]] — Ladder of causation
